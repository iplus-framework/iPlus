...
namespace gip.ext.design
{
    ...
    public interface IMoveableItemsList<T> : IList<T>
    {
        ...
        /// <returns></returns>
        int MoveForward(T item);
        /// <summary>
        /// 
        /// </summary>
        /// <param name="item"></param>
        /// <returns></returns>
        int MoveBackward(T item);
        /// <summary>
        /// 
        /// </summary>
        /// <param name="item"></param>
        /// <returns></returns>
        int MoveToFirst(T item);
        /// <summary>
        /// 
        /// </summary>
        /// <param name="item"></param>
        /// <returns></returns>
        int MoveToLast(T item);
    }
    ...
    public abstract class DesignItemProperty
    {
        ...
        /// <summary>
        /// Gets if the property-Type is a Dependency-Property
        /// </summary>
        public abstract bool IsDependencyProperty { get; }

        /// <summary>
        /// Gets if one of Parent-Design-Items is a Setter-Object
        /// </summary>
        public abstract bool IsParentSetter { get; }

        /// <summary>
        /// Gets the elements represented by the collection.
        /// </summary>
        public abstract IMoveableItemsList<DesignItem> CollectionElements { get; }
        ...
        /// </summary>
        public abstract void SetValueOnInstance(object value);
        ...
        /// Aktueller Wert 
        /// Getter:
        /// 1. Falls Const.Value gesetzt dann diesen verwenden
        /// 2. Ansonsten den "ValueOnInstance"
        /// </summary>
