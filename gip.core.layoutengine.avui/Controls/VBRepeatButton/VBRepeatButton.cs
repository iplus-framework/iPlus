...
{ 
    public class VBRepeatButton : RepeatButton, IVBContent, IACObject, IACCommandControl
    {
        ...
        protected virtual void InitVBControl(bool onLoad = false)
        {
            ...
            if (!String.IsNullOrEmpty(VBContent))
            {
                ...
                if (!bound)
                {
                    ...
                    if (menuItem == null)
                    {
                        this.Root().Messages.LogDebug("Error00003", "VBRepeatButton", VBContent);
#if DEBUG
                        System.Diagnostics.Debug.WriteLine("VBRepeatButton ACUrlBinding failed. VBContent: " + this.VBContent);
#endif
                        //IsVisible = false;
                        return;
                    }
                ...
                else
                {
                    ...
                    {
                        // Wurde ein VBRepeatButton per Datatemplate erzeugt, dann wei� man nicht zu welchem Datenobjekt (z.B. ausgew�hltes Item in der Listbox)
                        // der Button geh�rt. Durch ein Binding vom Datenobjekt zum CommandParameter (CommandParameter={Binding }), wird der Wert im Commandparameter gesetzt.
                    ...
                    if (BSOACComponent != null)
                    {
                        ...
                        this.Bind(VBRepeatButton.ACCompInitStateProperty, binding);
                    }
                    if (ContextACObject != null && ContextACObject is IACComponent)
                    {
                        ...
                        this.Bind(VBRepeatButton.ACUrlCmdMessageProperty, binding);
                    }
        ...
        public static readonly StyledProperty<Global.ControlModes> ControlModeProperty =
            AvaloniaProperty.Register<VBRepeatButton, Global.ControlModes>(nameof(ControlMode));
        ...
        public static readonly StyledProperty<ACUrlCmdMessage> ACUrlCmdMessageProperty =
            AvaloniaProperty.Register<VBRepeatButton, ACUrlCmdMessage>(nameof(ACUrlCmdMessage));
        ...
        public static readonly StyledProperty<ACInitState> ACCompInitStateProperty =
            AvaloniaProperty.Register<VBRepeatButton, ACInitState>(nameof(ACCompInitState));
        ...
        protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change)
        {
            ...
            VBRepeatButton thisControl = this;
        ...
        public static readonly StyledProperty<bool> IsTouchLeaveProperty =
            AvaloniaProperty.Register<VBRepeatButton, bool>(nameof(IsTouchLeave), false);
        ...
        protected override void OnLoaded(RoutedEventArgs e)
        {
            ...
            if (BSOACComponent != null)
            {
                ...
                {
                    this.Root().Messages.LogDebug("VBRepeatButton", "AddWPFRef", exw.Message);
                }
            }
            _Loaded = true;
        ...
        protected override void OnUnloaded(RoutedEventArgs e)
        {
            ...
            {
                this.Root().Messages.LogDebug("VBRepeatButton", "RemoveWPFRef", exw.Message);
            }
                    ...
                    if (!String.IsNullOrEmpty(VBContentAssignedValueMouseUp) && TypeMemberMouseUp != null)
                    {
                        ...
                        catch (Exception ec)
                        {
                            ...
                            if (datamodel.Database.Root != null && datamodel.Database.Root.Messages != null && datamodel.Database.Root.InitState == ACInitState.Initialized)
                                datamodel.Database.Root.Messages.LogException("VBRepeatButton", "OnPointerReleased", msg);
                        }
                    }
                ...
                if (!String.IsNullOrEmpty(VBContentMemberMouseDown) && ContextACObject != null)
                {
                    if (!String.IsNullOrEmpty(VBContentAssignedValueMouseDown) && TypeMemberMouseDown != null)
                    {
                        ...
                        catch (Exception ec)
                        {
                            ...
                            if (datamodel.Database.Root != null && datamodel.Database.Root.Messages != null && datamodel.Database.Root.InitState == ACInitState.Initialized)
                                datamodel.Database.Root.Messages.LogException("VBRepeatButton", "OnPointerPressed", msg);
                        }
                    }
        ...
        */
        ...
        public static readonly AttachedProperty<int> CanExecuteCyclicProperty =
            ContentPropertyHandler.CanExecuteCyclicProperty.AddOwner<VBRepeatButton>();
        ...
        /// </summary>
        /// <summary xml:lang="de">
        /// Bestimmt, ob die zyklische Ausf�hrung aktiviert oder deaktiviert ist. Der Wert (Integer) in dieser Eigenschaft bestimmt das Intervall der zyklischen Ausf�hrung in Millisekunden.
        /// </summary>
        [Category("VBControl")]
        ...
        public static readonly AttachedProperty<bool> DisableContextMenuProperty =
            ContentPropertyHandler.DisableContextMenuProperty.AddOwner<VBRepeatButton>();

        /// <summary>
        /// Determines is context menu disabled or enabled.
        /// </summary>
        /// <summary xml:lang="de">
        /// Ermittelt ist das Kontextmen� deaktiviert oder aktiviert
        /// </summary>
        [Category("VBControl")]
        [ACPropertyInfo(9999)]
        ...
        public void UpdateControlMode()
        {
            ...
            // Bei Datatemplates ist Button an IACObjects gebunden, die keine ControlModes handeln k�nnen
        ...
        public static readonly StyledProperty<string> DisabledModesProperty =
            AvaloniaProperty.Register<VBRepeatButton, string>(nameof(DisabledModes));
        /// <summary>
        ...
        public static readonly StyledProperty<string> VBContentProperty =
            AvaloniaProperty.Register<VBRepeatButton, string>(nameof(VBContent));
        ...
        public static readonly StyledProperty<bool> BindToBSOProperty =
            AvaloniaProperty.Register<VBRepeatButton, bool>(nameof(BindToBSO));
        ...
        public static readonly StyledProperty<bool> BindOnLoadEventProperty =
            AvaloniaProperty.Register<VBRepeatButton, bool>(nameof(BindOnLoadEvent));
        ...
        public static readonly AttachedProperty<IACBSO> BSOACComponentProperty =
            ContentPropertyHandler.BSOACComponentProperty.AddOwner<VBRepeatButton>();
        /// <summary>
        ...
        public static readonly StyledProperty<string> VBContentMouseDownProperty =
            AvaloniaProperty.Register<VBRepeatButton, string>(nameof(VBContentMouseDown));
        ...
        public static readonly StyledProperty<string> VBContentMouseUpProperty =
            AvaloniaProperty.Register<VBRepeatButton, string>(nameof(VBContentMouseUp));
