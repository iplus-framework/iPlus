...
namespace gip.core.layoutengine.avui
{
    internal class FlipViewScrollViewer : ContentControl, IScrollable, IScrollAnchorProvider
    {
        ...
        private void Presenter_PropertyChanged(object sender, AvaloniaPropertyChangedEventArgs e)
        {
            ...
            if (e.Property == ScrollContentPresenter.OffsetProperty && e.Priority != Avalonia.Data.BindingPriority.Animation)
            {
        ...
        private void AttachPresenter(ScrollContentPresenter presenter)
        {
            ...
            {
                IfUnset(ScrollContentPresenter.OffsetProperty, p => presenter.Bind(p, this.GetBindingObservable(FlipViewScrollViewer.OffsetProperty), BindingPriority.Template)),
