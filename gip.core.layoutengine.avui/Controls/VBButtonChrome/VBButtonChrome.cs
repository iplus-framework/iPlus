    ...
    public class VBButtonChrome : Control
    {
        private static List<CustomControlStyleInfo> _styleInfoList = new List<CustomControlStyleInfo> { 
            new CustomControlStyleInfo { wpfTheme = eWpfTheme.Gip, 
                                         ...
                                         styleUri = "/gip.core.layoutengine.avui;Component/Controls/VBButtonChrome/Themes/ButtonChromeStyleGip.xaml" },
            new CustomControlStyleInfo { wpfTheme = eWpfTheme.Aero, 
                                         styleName = "ButtonChromeStyleAero", 
                                         styleUri = "/gip.core.layoutengine.avui;Component/Controls/VBButtonChrome/Themes/ButtonChromeStyleAero.xaml" },
        };
        /// <summary>
