...
namespace gip.core.layoutengine.avui
{
    ...
    public class GridViewColumnCollection : AvaloniaList<GridViewColumn>
    {
        public GridViewColumnCollection()
            : base()
        {
            this.CollectionChanged += GridViewColumnCollection_CollectionChanged;
        }
        ...
        private void VerifyAccess()
        {
            if (IsImmutable)
            {
                throw new InvalidOperationException("ListView_GridViewColumnCollectionIsReadOnly");
            }
