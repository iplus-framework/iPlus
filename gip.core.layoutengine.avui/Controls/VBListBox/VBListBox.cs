...
namespace gip.core.layoutengine.avui
{
    ...
    public class VBListBox : ListBox, IVBContent, IVBSource, IACMenuBuilderWPFTree, IACObject
    {
        ...
        protected override Type StyleKeyOverride => typeof(VBListBox);
        ...
        protected override void OnPointerReleased(PointerReleasedEventArgs e)
        {
            ...
            else if (e.InitialPressMouseButton == MouseButton.Left && e.KeyModifiers.HasFlag(KeyModifiers.Control))
            {
        ...
        protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change)
        {
            ...
            //     if (_Initialized && !string.IsNullOrEmpty(VBContent) && ContextACObject != null)
            //     {
            //         _Initialized = false;
            //         InitVBControl();
            //     }
