...
namespace gip.core.layoutengine.avui.CodeCompletion
{
    ...
    public class XmlCompletionDataCollection : CollectionBase
    {
        ...
        /// <summary>
        /// Checks if completion data collection contains a completion data according given name.
        /// </summary>
        /// <param name="name">The name of completion data.</param>
        /// <returns>True if contains name, otherwise false.</returns>
