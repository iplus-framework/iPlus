...
namespace gip.core.layoutengine.avui
{
    ...
    public class VBFrameController : RoutedViewHost //, IACInteractiveObject, IACObject, IVBGui
    {
        ...
        //        this.Bind(VBFrameController.ACUrlCmdMessageProperty, binding);

        //        binding = new Binding();
        //        binding.Source = ContextACObject;
        //        binding.Path = Const.InitState;
        //        binding.Mode = BindingMode.OneWay;
        //        this.Bind(VBFrameController.ACCompInitStateProperty, binding);
        //    }
        //}
        ...
        //private void ShowVBDesign(Control uiElement, string acCaption = "", bool isBusinessObject = false)
        //{
        //    if (uiElement == null)
        //        return;
        ...
        //    if (page == null)
        //        return;
        //    Control uiElement = page.VBDesignContent;
        //    if (uiElement == null)
        //        return;
        //    if (!(uiElement is VBDesign))
        //        return;
