...
namespace gip.core.layoutengine.avui.ganttchart
{
    ...
    public class TimelineCompactPanel : TimelineGanttPanel
    {
        ...
        //public TimelineCompactPanel() : base()
        //{

        //}

        //protected override void SetChildRow(Control child, List<Control> measuredChildren)
        //{
        //    int childRow = -1;
        ...
        //    {
        //        foreach (Control previousChild in measuredChildren)
        //        {
        ...
        protected override void ArrangeChild(Control child, int rowIndex)
        {
