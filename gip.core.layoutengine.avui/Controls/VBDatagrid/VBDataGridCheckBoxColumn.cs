...
namespace gip.core.layoutengine.avui
{
    ...
    public class VBDataGridCheckBoxColumn : DataGridCheckBoxColumn, IGriColumn
    {
        ...
        public static readonly AttachedProperty<FontFamily> FontFamilyProperty =
            TextElement.FontFamilyProperty.AddOwner<VBDataGridCheckBoxColumn>();
        ...
        public static readonly AttachedProperty<double> FontSizeProperty =
            TextElement.FontSizeProperty.AddOwner<VBDataGridCheckBoxColumn>();
        ...
        public static readonly AttachedProperty<FontStyle> FontStyleProperty =
            TextElement.FontStyleProperty.AddOwner<VBDataGridCheckBoxColumn>();
        ...
        public static readonly AttachedProperty<FontWeight> FontWeightProperty =
            TextElement.FontWeightProperty.AddOwner<VBDataGridCheckBoxColumn>();
        ...
        public static readonly AttachedProperty<IBrush> ForegroundProperty =
            TextElement.ForegroundProperty.AddOwner<VBDataGridCheckBoxColumn>();
        ...
        public static readonly StyledProperty<IBrush> CellBackgroundProperty =
            AvaloniaProperty.Register<VBDataGridCheckBoxColumn, IBrush>(nameof(CellBackground));
        ...
        public static readonly StyledProperty<string> ConditionalForegroundPathProperty =
            AvaloniaProperty.Register<VBDataGridCheckBoxColumn, string>(nameof(ConditionalForegroundPath));
        ...
        public static readonly StyledProperty<string> ConditionalForegroundTrueColorProperty =
            AvaloniaProperty.Register<VBDataGridCheckBoxColumn, string>(nameof(ConditionalForegroundTrueColor));
        ...
        public static readonly StyledProperty<string> ConditionalForegroundFalseColorProperty =
            AvaloniaProperty.Register<VBDataGridCheckBoxColumn, string>(nameof(ConditionalForegroundFalseColor));
        ...
        public static readonly StyledProperty<string> ConditionalBackgroundPathProperty =
            AvaloniaProperty.Register<VBDataGridCheckBoxColumn, string>(nameof(ConditionalBackgroundPath));
        ...
        public static readonly StyledProperty<string> ConditionalBackgroundTrueColorProperty =
            AvaloniaProperty.Register<VBDataGridCheckBoxColumn, string>(nameof(ConditionalBackgroundTrueColor));
        ...
        public static readonly StyledProperty<string> ConditionalBackgroundFalseColorProperty =
            AvaloniaProperty.Register<VBDataGridCheckBoxColumn, string>(nameof(ConditionalBackgroundFalseColor));
        ...
        protected override Control GenerateEditingElementDirect(DataGridCell cell, object dataItem)
        {
            ...
            SyncProperties(checkBox);
            ApplyConditionalForegroundBinding(checkBox, TextElement.ForegroundProperty);
            ApplyConditionalBackgroundBinding(checkBox, TemplatedControl.BackgroundProperty);
        ...
        private void SyncProperties(AvaloniaObject content)
        {
            ...
            if (content is TemplatedControl templatedControl)
                templatedControl.Background = CellBackground;
        }
