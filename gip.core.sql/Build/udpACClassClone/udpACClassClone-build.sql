declare @acClassID uniqueidentifier;
declare @acIdentifier nvarchar(100);
declare @IsCloneACClassProperty bit;
declare @IsCloneACClassMethod bit;
declare @IsCloneACClassDesign bit;
declare @IsCloneACClassConfig bit;
declare @IsCloneACClassText bit;
declare @IsCloneACClassMessage bit;
declare @IsCloneACClassPropertyRelation bit;
declare @userID varchar(5);


set @acClassID = '3f8b3efc-10eb-4af6-bf70-5daac32f147a';
set @acIdentifier = 'ACMaintService(1)';

set @userID = 'aagincic'

set @IsCloneACClassProperty = 1;
set @IsCloneACClassMethod = 1;
set @IsCloneACClassDesign = 1;
set @IsCloneACClassConfig = 1;
set @IsCloneACClassText = 1;
set @IsCloneACClassMessage = 1;
set @IsCloneACClassPropertyRelation = 1;
...
select 
    'sourceTableTree' as sourceTableTree,
    * 
from @sourceTableTree;
select 
...
select 'confirmation'
select * from ACClass where ACClassID = @newId;

exec dbo.udpACClassDelete @newId
