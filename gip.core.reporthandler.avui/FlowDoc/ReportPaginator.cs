...
namespace gip.core.reporthandler.avui.Flowdoc
{
    ...
    protected DocumentPaginator _paginator = null;
        ...
        protected virtual void ProcessReport()
        {
            ...
            //FillCharts(charts);
            //gip.core.layoutengine.avui.Layoutgenerator.CurrentDataContext = _data.ReportDocumentValues.Values.Where(c => c is IACComponent).FirstOrDefault() as IACComponent;
