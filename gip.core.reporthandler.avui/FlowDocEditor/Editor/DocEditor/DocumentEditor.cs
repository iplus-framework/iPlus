...
namespace Document.Editor
{
    public class DocumentEditor : RichTextBox, INotifyPropertyChanged
    {
        ...
        private gip.core.reporthandler.avui.Flowdoc.VBReportEditor _ReportEditor;
        ...
        public DocumentEditor()
        {
            ...
            FontFamily = gip.core.reporthandler.avui.Properties.Settings.Default.Options_DefaultFont;
            FontSize = gip.core.reporthandler.avui.Properties.Settings.Default.Options_DefaultFontSize;
            AcceptsTab = true;
        ...
        private void DocumentEditor_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                _ReportEditor = gip.core.layoutengine.avui.Helperclasses.VBVisualTreeHelper.FindParentObjectInVisualTree(this, typeof(gip.core.reporthandler.avui.Flowdoc.VBReportEditor)) as gip.core.reporthandler.avui.Flowdoc.VBReportEditor;
            }
        }
