...
namespace gip.core.scichart.avui
{
    public class CodeCompletionXsdGeneratorVBC
    {
        ...
        internal static string vbcSchemaPath = @"\gip.core.scichart.avui\VBXMLEditorSchemas\VBCSchema.xsd";
        internal static string sciChartSchemaPath = @"\gip.core.scichart.avui\VBXMLEditorSchemas\SciChartSchema.xsd";
        ...
        public static void RunTool()
        {
            ...
            importSciChartSchema.SchemaLocation = "pack://application:,,,/gip.core.scichart.avui;component/VBXMLEditorSchemas/SciChartSchema.xsd";
            importSchemaList.Add(new Tuple<XmlSchemaImport, XmlQualifiedName>(importSciChartSchema, sNs));

            gen.RunTool("gip.core.scichart.avui", vbcNs, new Type[] { typeof(DependencyObject), typeof(SciChart.Charting.Visuals.Axes.LabelProviders.LabelProviderBase) }, importSchemaList, 
