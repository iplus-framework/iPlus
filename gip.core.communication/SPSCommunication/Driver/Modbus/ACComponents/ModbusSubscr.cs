...
{
    [ACClassInfo(Const.PackName_VarioSystem, "en{'ModbusSubscr'}de{'ModbusSubscr'}", Global.ACKinds.TACDAClass, Global.ACStorableTypes.Required, false, false)]
    public class ModbusSubscr : ACSubscription
    {
        #region c´tors
        static ModbusSubscr()
        {
            RegisterExecuteHandler(typeof(ModbusSubscr), HandleExecuteACMethod_ModbusSubscr);
        }

        public ModbusSubscr(ACClass acType, IACObject content, IACObject parentACObject, ACValueList parameter, string acIdentifier = "")
                ...
                using (ACMonitor.Lock(LockMemberList_20020))
                {
                    ...
                    catch (Exception e)
                    {
                        ...
                        if (datamodel.Database.Root != null && datamodel.Database.Root.Messages != null && datamodel.Database.Root.InitState == ACInitState.Initialized)
                            datamodel.Database.Root.Messages.LogException("ModbusSubscr", "S7Properties", msg);
                    }
                }
                return null;
            }
        ...
        private ModbusDataBlocksRAM _PLCRAMOfDataBlocks = null;
        internal ModbusDataBlocksRAM PLCRAMOfDataBlocks
        {
            get
            {
                if (_PLCRAMOfDataBlocks == null)
                {
                    _PLCRAMOfDataBlocks = new ModbusDataBlocksRAM();
        ...
        protected ModbusSession ModbusSession
        {
            get
            {
                return ParentACComponent as ModbusSession;
            }
        }
        ...
        public EndianessEnum Endianess
        {
            get
            {
                return ModbusSession.Endianess;
            }
        }
...
#region Methods
        ...
        public static bool HandleExecuteACMethod_ModbusSubscr(out object result, IACComponent acComponent, string acMethodName, gip.core.datamodel.ACClassMethod acClassMethod, params object[] acParameter)
        {
        ...
        public override bool InitSubscription()
        {
            ...
            Messages.LogDebug(this.GetACUrl(), "ModbusSubscr.InitSubscription(1)", "");
            ...
            Messages.LogDebug(this.GetACUrl(), "ModbusSubscr.InitSubscription(5)", "");
...
#region Event-Handler
        private void InitWorkCycleEventHandler(bool Remove)
        {
            ...
            if (ModbusSession != null && !IsWriteOnly)
        ...
        private void HandlePropertyChangedDelegate(object sender, EventArgs e)
        {
                ...
                || _DelegateWriteAlarmDisappeared)
            {
                try
                {
                    ...
                    {
                        OnNewAlarmOccurred(ReadAlarm, new Msg(delegateConnAlarmOccurred, this, eMsgLevel.Error, "ModbusSubscr", "HandlePropertyChangedDelegate", 1000));
                    }
                    if (delegateWriteAlarmOccurred != null)
                    {
                        OnNewAlarmOccurred(WriteAlarm, new Msg(delegateWriteAlarmOccurred, this, eMsgLevel.Error, "ModbusSubscr", "HandlePropertyChangedDelegate", 1010));
                    }
                ...
                catch (Exception ec)
                {
                    ...
                    if (datamodel.Database.Root != null && datamodel.Database.Root.Messages != null && datamodel.Database.Root.InitState == ACInitState.Initialized)
                        datamodel.Database.Root.Messages.LogException("ModbusSubscr", "HandlePropertyChangedDelegate", msg);
                }
                finally
                {
                }
