...
namespace gip.core.communication
{
    ...
    public class OPCUAClientACService : OPCClientACService
    {
        ...
        public override bool ACInit(Global.ACStartTypes startChildMode = Global.ACStartTypes.Automatic)
        {
            ...
            _OPCUAThread = new ACThread(ManageLifeOfOPCUAApp);
            _OPCUAThread.Name = "ACUrl:" + this.GetACUrl() + ";ManageLifeOfOPCUAApp();";
            _OPCUAThread.Start();
        ...
        private void ManageLifeOfOPCUAApp()
        {
            InitOPCUAApp();
        ...
        private void InitOPCUAApp()
        {
            ...
            if (UseCertificate)
            {
                ...
                if (taskCert != null)
                {
                    ...
                    {
                        AppConfiguration.ApplicationUri = Utils.GetApplicationUriFromCertificate(AppConfiguration.SecurityConfiguration.ApplicationCertificate.Certificate);
