...
namespace gip.core.tcShared.WCF
{
    ...
    [ServiceContract(CallbackContract = typeof(IWcfAdsServiceCallback), SessionMode = SessionMode.Required)]
    public interface IWcfAdsService
    {
        [OperationContract(IsOneWay = true)]
        void Invoke(WcfAdsMessage message);
    }
}