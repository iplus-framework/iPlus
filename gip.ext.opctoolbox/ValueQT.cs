...
//                                                                            |
//  Description : Value-Quality-Timestamp transport classes                   |
//                                                                            |
//-----------------------------------------------------------------------------
using System;
...
namespace Softing.OPCToolbox{
	...
	public class ValueData{
		...
		/// <include 
		///  file='TBN.doc.xml' 
		///  path='//class[@name="ValueData"]/method[@name="GetVartype"]/doc/*'
		/// />	
	...
	public class ValueQT : ValueData{
		...
		internal const int VARIANT_SIZE = 0x10;
		...
		public bool IsTimeStampSet() {
			...
			return ((m_timeStamp.Hour != 0 ) && (m_timeStamp.Minute != 0) && (m_timeStamp.Second != 0)&& (m_timeStamp.Millisecond != 0));
		}
