...
//                                                                            |
//  Description : Generic use OPC enumerations                                |
//                                                                            |
//-----------------------------------------------------------------------------
...
namespace Softing.OPCToolbox {
	...
	/// <summary>
	/// Describes the toolbox application licensed features.
	/// </summary>
	/// <include 
	///  file='TBN.doc.xml' 
	...
	public enum EnumResultCode : int {
		...
		S_OK =	0, //0x00000000
		/// <summary> The operation succeeded but there are one or more minor errors.
		/// The individual errors must be analyzed for more information.</summary>
		S_FALSE = 1, //0x00000001
		/// <summary> The function is not implemented in the base class and should be overridden.</summary>
		E_NOTIMPL = -2147221503, //0x80040001
		/// <summary>
		/// Not enough memory to complete the requested operation.</summary>
		E_OUTOFMEMORY = -2147024882, //0x8007000E,
		/// <summary>The value of one or more parameters was not valid.</summary>
		E_INVALIDARG = -2147024809, //0x80070057,
		/// <summary>
		/// No such interface supported.</summary>
		E_NOINTERFACE  = -2147467262,//0x80004002,
		/// <summary>Execution access of current action is denied.</summary>
		E_ACCESSDENIED = -2147024891,//0x80070005,
		/// <summary>The function could not complete the designed action.The error is not specified.</summary>
		E_FAIL = -2147221499,//0x80040005,
		/// <summary>Unexpected error not matching one of the other values.</summary>
		E_UNEXPECTED = -2147418113,//0x8000FFFF,
		/// <summary>There is no existing connection.</summary>
		CONNECT_E_NOCONNECTION = -2147220992,//0x80040200,
		/// <summary>Advise limit exceeded for this object.</summary>
		...
		/// <summary>The value of the handle is invalid.</summary>
		...
		/// <summary>The requested operation cannot be done on a public group.</summary>
	    E_PUBLIC = -1073479675,//0xC0040005,
		/// <summary> The item's <see cref="Softing.OPCToolbox.Client.DaItem.AccessRights"/> do not allow the operation.</summary>
		E_BADRIGHTS = -1073479674,//0xC0040006,
		/// <summary>The item ID is not defined in the server address space (on add or validate) or no longer 
		/// exists in the server address space (for read or write).</summary>
		E_UNKNOWNITEMID = -1073479673,//0xC0040007,
		/// <summary> The item ID doesn't conform to the server's syntax.</summary>
		E_INVALIDITEMID = -1073479672,//0xC0040008,
		/// <summary>The filter string was not valid.</summary>	
		E_INVALIDFILTER = -1073479671,//0xC0040009,
		/// <summary>The item's access path is not known to the server.</summary>
		...
		/// <summary>The operation cannot be performed because the object is being referenced.</summary>		
		S_INUSE = 262159,//0x0004000F,
		/// <summary>The server's configuration file is an invalid format.</summary>
		E_INVALIDCONFIGFILE = -1073479664,//0xC0040010,
		/// <summary>The requested object (e.g. a public group) was not found.</summary>		
		...
		/// <summary>The item deadband has not been set for this item.</summary>
		E_DEADBANDNOTSET = -1073478656,//0xC0040400,
		/// <summary>The item does not support deadband.</summary>		
		E_DEADBANDNOTSUPPORTED = -1073478655,//0xC0040401,
		/// <summary>The server does not support buffering of data items that are collected at a faster rate than the group update rate.</summary>		
		...
		/// <summary>Indicates that not every detected change has been returned for this item. Only the most recent data is provided.</summary>	
		S_DATAQUEUEOVERFLOW = 263172,//0x00040404,
		/// <summary>Indicates that there is no sampling rate set for a particular item. In this case, the item 
		/// defaults to the update rate of the group.</summary>		
		E_RATENOTSET = -1073478651,//0xC0040405,
		/// <summary>If a client attempts to write any value, quality, timestamp combination and the server does not 
	...
	public class ResultCode{		
		...
		/// <include 
		///  file='TBN.doc.xml' 
		///  path='//class[@name="ResultCode"]/constant[@name="ERROR_MASK"]/doc/*'
		/// />
		...
		/// <include 
		///  file='TBN.doc.xml' 
		///  path='//class[@name="ResultCode"]/constant[@name="SUCCESS_MASK"]/doc/*'
		/// />
		...
		/// </summary>
		/// <param name = "res">A <see cref=TypeAnalyser._TypeName_UInt32/> that represents a result to be tested on success.</param>
		/// <returns>
		...
		/// />	
		static public bool SUCCEEDED(int res) 
		{
		...
		/// />
		static public bool SUCCEEDED(EnumResultCode res) {
		...
		/// </summary>
		/// <param name = "res">A <see cref=TypeAnalyser._TypeName_UInt32/> that represents a result to be tested on failure.</param>
		/// <returns>
		...
		/// />
		static public bool FAILED(int res) {
		...
		/// />
		static public bool FAILED(EnumResultCode res) {
