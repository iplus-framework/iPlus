...
namespace Softing.OPCToolbox.Client {
	...
	#region //Public Delegates
		...
		/// <para lang="Visual Basic, C#, C++">Represents the method that will handle the <see cref="Softing.OPCToolbox.Client.DaItem.ValueChanged"/>
	...
	public class DaItem : ObjectSpaceElement, ISerializable{
		...
		/// <include 
		///  file='TBNC.doc.xml' 
		///  path='//class[@name="DaItem"]/field[@name="m_valueQTJanitor"]/doc/*'
		/// />
		...
		/// <summary>
		/// <para lang="Visual Basic, C#, C++">Gets the string representation for the item's value.</para>
		/// <para lang="Unmanaged C++"> This property is not available for Unmanaged C++.</para>
		/// </summary>
		/// <include 
		///  file='TBNC.doc.xml' 
			...
			ExecutionOptions executionOptions)
		{
			...
			if (m_subscription == null){
				...
				try{
					...
					Win32Functions.VariantClear(aValue[0].m_value);
			...
			ExecutionOptions executionOptions)
		{
			...
			if (m_subscription == null){
				...
				try{
					...
					Win32Functions.VariantClear(inValues[0].m_value);
