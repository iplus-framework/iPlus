...
//                             OPC Toolbox .NET                               |
//                                                                            |
//  Filename    : ClientDaSession.cs                                          |
//  Version     : 4.22.release                                                |
//  Date        : 15-December-2008                                            |
//                                                                            |
//  Description : A client - OPC DA Server session class                      |
//                                                                            |
//-----------------------------------------------------------------------------
...
namespace Softing.OPCToolbox.Client {
	...
	///<para lang="Visual Basic, C#, C++">Represents the method that will handle the <see cref="Softing.OPCToolbox.Client.DaSession.ReadCompleted"/> 
	...
	/// <summary>
	///<para lang="Unmanaged C++">This is not available for Unmanaged C++.</para>
	///<para lang="Visual Basic, C#, C++">Represents the method that will handle the <see cref="Softing.OPCToolbox.Client.DaSession.WriteCompleted"/> 
	///event of a <see cref="DaSession"/>.</para>
	/// </summary>
	...
	/// <summary>
	///<para lang="Unmanaged C++">This is not available for Unmanaged C++.</para>
	///<para lang="Visual Basic, C#, C++"> Represents the method that will handle the <see cref="Softing.OPCToolbox.Client.DaSession.GetStatusCompleted"/>
	...
	/// <summary>
	///<para lang="Unmanaged C++">This is not available for Unmanaged C++.</para>
	///<para lang="Visual Basic, C#, C++"> Represents the method that will handle the <see cref="Softing.OPCToolbox.Client.DaSession.BrowseCompleted"/>
	/// event of a <see cref="DaSession"/>.</para>
	///</summary>
	...
	/// <summary>
	///<para lang="Unmanaged C++">This is not available for Unmanaged C++.</para>
	/// <para lang="Visual Basic, C#, C++">Represents the method that will handle the <see cref="Softing.OPCToolbox.Client.DaSession.GetDaPropertiesCompleted"/>
	/// event of a <see cref="DaSession"/>.</para>
	/// </summary>
	...
	/// <summary>
	/// <para lang="Unmanaged C++">This is not available for Unmanaged C++.</para>
	/// <para lang="Visual Basic, C#, C++">Represents the method that will handle the <see cref="Softing.OPCToolbox.Client.DaSession.GetErrorStringCompleted"/>
	/// event of a <see cref="DaSession"/> or of an <see cref="AeSession"/>.</para>
	/// </summary>
	...
	/// <summary>
	/// <para lang="Unmanaged C++">This is not available for Unmanaged C++.</para>
	/// <para lang="Visual Basic, C#, C++">Represents the method that will handle the <see cref="Softing.OPCToolbox.Client.DaSession.LogonCompleted"/> 
	/// event of a <see cref="DaSession"/> or of an <see cref="AeSession"/>.</para>
	/// </summary>
	...
	/// <summary>
	/// <para lang="Unmanaged C++">This is not available for Unmanaged C++.</para>
	/// <para lang="Visual Basic, C#, C++">Represents the method that will handle the <see cref="Softing.OPCToolbox.Client.DaSession.LogoffCompleted"/>
	/// event of a <see cref="DaSession"/> or of an <see cref="AeSession"/>.</para>
	/// </summary>
	...
	public class DaSession : ObjectSpaceElement,ISerializable{ 
		...
		///<para lang="Visual Basic, C#, C++">This event is raised by asynchronously executing the <see cref="Read"/> method.</para>
		///<para lang="Unmanaged C++">The method is called after the method <see cref="Read"/> has been asynchronously executed.</para>
		/// </summary>
		/// <include 
		///  file='TBNC.doc.xml' 
		...
		///<para lang="Visual Basic, C#, C++">This event is raised by asynchronously executing the <see cref="Write"/> method.</para>
		///<para lang="Unmanaged C++">The method is called after the method <see cref="Write"/> has been asynchronously executed.</para>				
		/// </summary>
		/// <include 
		///  file='TBNC.doc.xml' 
		...
		///<para lang="Visual Basic, C#, C++">This event is raised by asynchronously executing the <see cref="GetDaProperties"/> method.</para>
		///<para lang="Unmanaged C++">The method is called after the method <see cref="GetDaProperties"/> has been asynchronously executed.</para>										
		/// </summary>
		/// <include 
		///  file='TBNC.doc.xml' 
		...
		public DaSubscription[] SubscriptionList{
			get{
				...
				DaSubscription[] subscriptionVector = new DaSubscription[subscriptionTable.Count];
				int i = 0;

				foreach(DaSubscription daSubscription in subscriptionTable.Values){
			...
			ExecutionOptions executionOptions)
		{
			...
			try{
				...
				for(int i = 0; i<itemIDs.Length; i++){
					Win32Functions.VariantClear(outValues[i].m_value);
			...
			ExecutionOptions executionOptions)
		{
			...
			try{
				...
				for(int i = 0; i< itemIDs.Length; i++){						
					//inValues[i].m_quality = 0xFFFF;		
					inValues[i].m_quality = (ushort)values[i].Quality;
					if (values[i].TimeStamp == DateTime.MinValue)
					{
						OTDateTime otDateTime;
						otDateTime.dwHighDateTime = 0;
						otDateTime.dwLowDateTime = 0;

						inValues[i].m_timestamp = otDateTime;
					}
					else
					{
				...
				for(int i = 0; i<itemIDs.Length; i++){
					Win32Functions.VariantClear(inValues[i].m_value);
		...
		public virtual int GetDaProperties(
			...
			ExecutionOptions executionOptions)
		{
			return GetDaProperties(null, anAddressSpaceElementId, anAddressSpaceElementPath, aGetPropertyOptions, out someDaProperties, executionOptions);
		}
			...
			try{
				...
				if (aGetPropertyOptions != null){
					if (aGetPropertyOptions.PropertyIds != null){
						int memorySize = aGetPropertyOptions.PropertyIds.Length * Marshal.SizeOf(typeof(System.UInt16));
					...
					if (aGetPropertyOptions.PropertyNames != null){
						...
						IntPtr[] stringPointers = new IntPtr[aGetPropertyOptions.PropertyNames.Length];				
						...
						for (int index = 0; index < aGetPropertyOptions.PropertyNames.Length; index++){					
							...
							Marshal.WriteIntPtr(otcPropertyOptions.m_pPropertyNames, index * Marshal.SizeOf(typeof(IntPtr)), stringPointers[index]);
						}	//	end for
					}	//	end if
				...
				if (ResultCode.SUCCEEDED(res))
				{
					...
					if (options.m_executionType == (byte)EnumExecutionType.SYNCHRONOUS)
					{
						if (propertiesDataCount > 0)
						{
							...
							{
								myData = (OTCDAPropertyData)Marshal.PtrToStructure((IntPtr)((int)pPropertyData + (structSize * index)), typeof(OTCDAPropertyData));
								...
								{
									Win32Functions.VariantClear(myData.m_value.m_value);
