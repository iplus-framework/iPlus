...
//                             OPC Toolbox .NET                               |
//                                                                            |
//  Filename    : ClientObjectSpaceElement.cs                                 |
...
namespace Softing.OPCToolbox.Client{
	...
	/// <para lang="Visual Basic, C#, C++">Represents the method that will handle the 
	...
	/// <summary>
	/// <para lang="Unmanaged C++">This is not available for Unmanaged C++.</para>
	/// <para lang="Visual Basic, C#, C++">Represents the method that will handle the <see cref=" Softing.OPCToolbox.Client.ObjectSpaceElement.GetAttributesFromServerCompleted">
	...
	/// <summary>
	///<para lang="Unmanaged C++">This is not available for Unmanaged C++.</para>
	/// <para lang="Visual Basic, C#, C++">Represents the method that will handle the <see cref=" Softing.OPCToolbox.Client.ObjectSpaceElement.SetAttributesToServerCompleted">SetAttributesToServerCompleted</see> event 
	...
	/// <summary>
	///<para lang="Unmanaged C++">This is not available for Unmanaged C++.</para>
	/// <para lang="Visual Basic, C#, C++">Represents the method that will handle the <see cref=" Softing.OPCToolbox.Client.ObjectSpaceElement.PerformStateTransitionCompleted">PerformStateTransitionCompleted</see> event 
	/// of an <see cref="ObjectSpaceElement"/> object.</para>
	/// </summary>
	...
	/// <summary>
	/// Provides the base functionality for all the objects in the toolbox which are modelling OPC objects.
	/// </summary>
	/// <include 
	///  file='TBNC.doc.xml' 
	...
	public class ObjectSpaceElement {
		...
		///<para lang="Visual Basic, C#, C++">This event is raised by asynchronously executing the <see cref="Connect"/> or <see cref="Disconnect"/> methods.</para>
		///<para lang="Unmanaged C++">The method is called after the methods <see cref="Connect"/> or <see cref="Disconnect"/> 
		...
		///<para lang="Visual Basic, C#, C++">This event is raised by asynchronously executing the <see cref="GetAttributesFromServer"/> method.</para>
		///<para lang="Unmanaged C++">The method is called after the method <see cref="GetAttributesFromServer"/> has been asynchronously executed.</para>
		/// </summary>
		/// <include 
		///  file='TBNC.doc.xml' 
		...
		///<para lang="Visual Basic, C#, C++">This event is raised by asynchronously executing the <see cref="SetAttributesToServer"/> method.</para>
		///<para lang="Unmanaged C++">The method is called after the method <see cref="SetAttributesToServer"/> has been asynchronously executed.</para>
		/// </summary>
		/// <include 
		///  file='TBNC.doc.xml' 
		...
		///<para lang="Visual Basic, C#, C++">This event is raised by asynchronously executing the <see cref="PerformStateTransition"/> method.</para>
		///<para lang="Unmanaged C++">The method is called after the method <see cref="PerformStateTransition"/> has been asynchronously executed.</para>
		/// </summary>
		/// <include 
		///  file='TBNC.doc.xml' 
		...
		private IntPtr m_objectHandle = IntPtr.Zero;
		...
		/// <include 
		///  file='TBNC.doc.xml' 
		///  path='//class[@name="ObjectSpaceElement"]/field[@name="m_currentState"]/doc/*'
		/// />
		protected EnumObjectState m_currentState = EnumObjectState.DISCONNECTED ;  
		///<summary>
		///The current status of the server.
		///</summary>	
		/// <include 
		///  file='TBNC.doc.xml' 
		///  path='//class[@name="ObjectSpaceElement"]/field[@name="m_targetState"]/doc/*'
		/// />
		protected EnumObjectState m_targetState = EnumObjectState.DISCONNECTED;
			...
			get {
				...
				try{										
					...
					if (ResultCode.SUCCEEDED(res)){
						m_currentState = (EnumObjectState)currentState;
						m_targetState = (EnumObjectState)targetState;
					}	//	end if										
				}
				catch(Exception exc) {
		...
		public EnumObjectState TargetState{
			...
			set{
				try{
					EnumObjectState m_targetState = value;
