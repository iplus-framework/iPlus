...
//                             OPC Toolbox .NET                               |
//                                                                            |
//  Filename    : ClientServerStatus.cs                                       |
...
namespace Softing.OPCToolbox.Client {
	...
	public class ServerStatus{
		...
		//---------------------------
		 ...
		 /// />   
		 protected readonly int m_groupCount = 0;  
		 ///<summary>
		 ...
		 /// />          
		 protected readonly int m_bandwidth = 0;       
		 ///<summary>
		...
		internal ServerStatus( uint state, DateTime startTime,
							 ...
							 DateTime lastUpdateTime, int groupCount,
							 int bandwidth,String statusInfo){
			m_state = state;                
