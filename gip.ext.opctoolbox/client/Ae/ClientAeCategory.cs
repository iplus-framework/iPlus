...
namespace Softing.OPCToolbox.Client{
	...
	/// <para lang="Visual Basic, C#, C++">Represents the method that will handle the <see cref="Softing.OPCToolbox.Client.AeCategory.QueryAeAttributesCompleted"/> event of a <see cref="AeCategory"/>.</para>
	/// </summary>
	...
	/// <summary>
	///<para lang="Unmanaged C++">This is not available for Unmanaged C++.</para>
	/// <para lang="Visual Basic, C#, C++">Represents the method that will handle the <see cref="Softing.OPCToolbox.Client.AeCategory.QueryAeConditionNamesCompleted"/> event of a <see cref="AeCategory"/>.</para>
	/// </summary>
	...
	/// <summary>
	///<para lang="Unmanaged C++">This is not available for Unmanaged C++.</para>
	/// <para lang="Visual Basic, C#, C++">Represents the method that will handle the <see cref="Softing.OPCToolbox.Client.AeCategory.QueryAeSubConditionNamesCompleted"/> event of a <see cref="AeCategory"/>.</para> 
	/// </summary>
	...
	public class AeCategory {			
		...
		///<para lang="Visual Basic, C#, C++">This event is raised by asynchronously executing the <see cref="QueryAeAttributes"/> method.</para>
		///<para lang="Unmanaged C++">The method is called after the method <see cref="QueryAeAttributes"/> has been asynchronously executed.</para>			
		/// </summary>
		/// <include 
		///  file='TBNC.doc.xml' 
		...
		///<para lang="Visual Basic, C#, C++">This event is raised by asynchronously executing the <see cref="QueryAeConditionNames"/> method.</para>
		///<para lang="Unmanaged C++">The method is called after the method <see cref="QueryAeConditionNames"/> has been asynchronously executed.</para>		
		/// </summary>
		/// <include 
		///  file='TBNC.doc.xml' 
		...
		///<para lang="Visual Basic, C#, C++">This event is raised by asynchronously executing the <see cref="QueryAeSubConditionNames"/> method.</para>
		///<para lang="Unmanaged C++">The method is called after the method <see cref="QueryAeSubConditionNames"/> has been asynchronously executed.</para>	 
		/// </summary>
		/// <include 
		///  file='TBNC.doc.xml' 
				...
				if(ResultCode.SUCCEEDED(res)){
					if (options.m_executionType == (byte)EnumExecutionType.SYNCHRONOUS)
					{
						...
						for (int i = 0; i< attributesCount; i++){
							uint attributeID = (uint)Marshal.PtrToStructure((IntPtr)((uint)attributeIDs + (i * uintSize)) ,typeof(uint));
							ushort attributeDataType = (ushort)Marshal.PtrToStructure((IntPtr)((uint)attributeDataTypes + (i * ushortSize)) ,typeof(ushort));
							IntPtr attributeDescription = (IntPtr)Marshal.PtrToStructure((IntPtr)((uint)attributeDescriptions + (i * ptrSize)) ,typeof(IntPtr));
				...
				if(ResultCode.SUCCEEDED(res)){	
					if (options.m_executionType == (byte)EnumExecutionType.SYNCHRONOUS)
					{
						...
						for (int i = 0; i< count; i++){
							IntPtr conditionName = (IntPtr)Marshal.PtrToStructure(
														(IntPtr)((uint)pConditionNames + (i * ptrSize)),
														typeof(IntPtr));
			...
			try{
				...
				if(ResultCode.SUCCEEDED(res)){	
					if (options.m_executionType == (byte)EnumExecutionType.SYNCHRONOUS)
					{
						...
						for (int i = 0; i< count; i++)
						{
							IntPtr subConditionName = (IntPtr)Marshal.PtrToStructure((IntPtr)((uint)pSubConditionNames + (i * ptrSize)) ,typeof(IntPtr));
