...
//                             OPC Toolbox .NET                               |
//                                                                            |
//  Filename    : ClientAeSubscription.cs                                     |
//  Version     : 4.22.release                                                |
//  Date        : 15-December-2008                                            |
//                                                                            |
//  Description : AE Subscription class for monitoring event sources          |
//                                                                            |
//-----------------------------------------------------------------------------
...
namespace Softing.OPCToolbox.Client{
	...
	///<para lang="Visual Basic, C#, C++">Represents the method that will handle the <see cref="Softing.OPCToolbox.Client.AeSubscription.AeEventsReceived"/> event of a <see cref="AeSubscription"/>.</para>
	/// </summary>
	...
	/// />
	public delegate void AeEventsReceivedEventHandler(AeSubscription anAeSubscription,bool isRefresh, bool lastRefresh,AeEvent[] events);
	/// <summary>
	///<para lang="Unmanaged C++">This is not available for Unmanaged C++.</para>
	///<para lang="Visual Basic, C#, C++">Represents the method that will handle the <see cref="Softing.OPCToolbox.Client.AeSubscription.RefreshAeConditionsCompleted"/> event of a <see cref="AeSubscription"/>.</para>
	/// </summary>
	...
	/// <summary>
	///<para lang="Unmanaged C++">This is not available for Unmanaged C++.</para>
	///<para lang="Visual Basic, C#, C++">Represents the method that will handle the <see cref="Softing.OPCToolbox.Client.AeSubscription.CancelRefreshAeConditionsCompleted"/> event of a <see cref="AeSubscription"/>.</para>
	/// </summary>
	...
	/// />
	public delegate void CancelRefreshAeConditionsEventHandler(AeSubscription anAeSubscription,uint executionContext,int result);
	/// <summary>
	///<para lang="Unmanaged C++">This is not available for Unmanaged C++.</para>
	///<para lang="Visual Basic, C#, C++">Represents the method that will handle the <see cref="Softing.OPCToolbox.Client.AeSubscription.AeConditionsChanged"/> event of a <see cref="AeSubscription"/>.</para>	
	/// </summary>
	///<param name="anAeSubscription"> The <see cref="DaSubscription"/> object to whom the <see cref="Softing.OPCToolbox.Client.AeSubscription.CancelRefreshAeConditionsCompleted"/> event belongs.</param>
	...
	public class AeSubscription : ObjectSpaceElement {
		...
		///<para lang="Visual Basic, C#, C++">This event is raised by asynchronously executing the <see cref="RefreshAeConditions"/> method.</para>
		///<para lang="Unmanaged C++">The method is called after the method <see cref="RefreshAeConditions"/> has been asynchronously executed.</para>
		/// </summary>
		/// <include 
		///  file='TBNC.doc.xml' 
		...
		///<para lang="Visual Basic, C#, C++">This event is raised by asynchronously executing the <see cref="CancelRefreshAeConditions"/> method.</para>
		///<para lang="Unmanaged C++">The method is called after the method <see cref="CancelRefreshAeConditions"/> has been asynchronously executed.</para>
		/// </summary>
		/// <include 
		///  file='TBNC.doc.xml' 
							...
							if(ResultCode.SUCCEEDED(getAttrsResult)) {
								...
								if(objectAttributes.m_aeSubscriptionFilterCategrories != IntPtr.Zero){
									for(int i = 0; i< objectAttributes.m_aeSubscriptionFilterCountCategrories; i++){
										uint myData = (uint)Marshal.PtrToStructure((IntPtr)((uint)objectAttributes.m_aeSubscriptionFilterCategrories + (uintSize*i)),typeof(uint));
										categories[i] = myData;
									}
				...
				try{
					...
					if(this.Handle != IntPtr.Zero){
						...
						lock(m_attributesJanitor){
							...
							if(categories != null){
								int memorySize = categories.Length * Marshal.SizeOf(typeof(uint));
							...
							if(ResultCode.SUCCEEDED(getAttrsResult)) 
							{
								...
								if(objectAttributes.m_aeSubscriptionFilterAreas != IntPtr.Zero){
									for(int j = 0; j< count; j++){
										IntPtr myData = (IntPtr)Marshal.PtrToStructure((IntPtr)((uint)objectAttributes.m_aeSubscriptionFilterAreas + (Marshal.SizeOf(typeof(IntPtr))*j)),typeof(IntPtr));
						...
						lock(m_attributesJanitor){
							...
							if (areas != null){
								...
								for (int index = 0; index < areas.Length; index++){					
									...
									Marshal.WriteIntPtr(objectAttributes.m_aeSubscriptionFilterAreas, index* Marshal.SizeOf(typeof(IntPtr)), stringPointers[index]);
								}	//	end for
						...
						lock(m_attributesJanitor){
							...
							if(ResultCode.SUCCEEDED(getAttrsResult)) 
							{
								...
								if(objectAttributes.m_aeSubscriptionFilterSources != IntPtr.Zero){
									for(int j = 0; j< count; j++){
										IntPtr myData = (IntPtr)Marshal.PtrToStructure((IntPtr)((uint)objectAttributes.m_aeSubscriptionFilterSources + (Marshal.SizeOf(typeof(IntPtr))*j)),typeof(IntPtr));
						...
						lock(m_attributesJanitor){
							...
							if (sources != null){
								...
								for (int index = 0; index < sources.Length; index++){					
									...
									Marshal.WriteIntPtr(objectAttributes.m_aeSubscriptionFilterSources, index * Marshal.SizeOf(typeof(IntPtr)), stringPointers[index]);
								}	//	end for
						...
						lock(m_attributesJanitor){
							...
							if(ResultCode.SUCCEEDED(getAttrsResult)) 
							{
								...
								if(objectAttributes.m_aeSubscriptionReturnedAttributes != IntPtr.Zero){
									for(int j = 0; j< count; j++){
										OTCAEReturnedAttributesData myData = (OTCAEReturnedAttributesData)Marshal.PtrToStructure((IntPtr)((uint)objectAttributes.m_aeSubscriptionReturnedAttributes + (Marshal.SizeOf(typeof(OTCAEReturnedAttributesData))*j)),typeof(OTCAEReturnedAttributesData));
										if(myData != null){
											...
											for(int jj = 0; jj < myData.m_countAttributeIDs; jj++){
												uint anAttribut = (uint)Marshal.PtrToStructure((IntPtr)((uint)myData.m_attributeIDs + (Marshal.SizeOf(typeof(uint))*jj)),typeof(uint));
