...
//                             OPC Toolbox .NET                               |
//                                                                            |
//  Filename    : ClientAeCondition.cs                                        |
//  Version     : 4.22.release                                                |
//  Date        : 15-December-2008                                            |
//                                                                            |
//  Description : Represents the OPC AE Condition class                       |
//                                                                            |
//-----------------------------------------------------------------------------
...
namespace Softing.OPCToolbox.Client{
	...
	public class AeConditionState{
		...
		public string ActiveSubConditionDefinition{
			...
			set{
				m_actSubConditionDefinition = value;
			}
		}
		/// <summary>
		...
		public uint ActiveSubConditionSeverity{
			...
			set{
				m_actSubConditionSeverity = value;
			}
		}
		/// <summary>
		...
		public string ActiveSubConditionDescription{
			...
			set{
				m_actSubConditionDescription = value;
			}
		}
		/// <summary>
		...
		public DateTime SubConditionActiveTime{
			...
			set{
				m_subConditionActiveTime = value;
			}
		}
		/// <summary>
		...
		public string[] SubConditionsDefinitions{
			...
			set{
				m_pSubConditionDefinition = value;
			}
		}
		/// <summary>
		...
		public string[] SubConditionsDescriptions{
			...
			set{
				m_pSubConditionDescription = value;
			}
		}
		/// <summary>
