...
//                             OPC Toolbox .NET                               |
//                                                                            |
//  Filename    : ClientInfoCollector.cs                                      |
//  Version     : 4.22.release                                                |
//  Date        : 15-December-2008                                            |
//                                                                            |
//  Description : Configuring the DataControl class.                          |
//                                                                            |
//-----------------------------------------------------------------------------
...
namespace Softing.OPCToolbox.Client.Control {
	...
	public class InfoCollector : System.Windows.Forms.Form {
		...
		[StructLayout(LayoutKind.Sequential)]
			...
			private UInt32 sv101_platform_id;
		...
		ControlDaSession m_session = new ControlDaSession(string.Empty);		
			...
			TreeNode parent)
		{
			try{
				...
				if (ResultCode.SUCCEEDED(serverBrowser.Browse(specification, EnumServerBrowserData.ALL, out serverData, m_executionOptions))) {
		...
		private void ChangeNumberOfItemsField( ){
			...
			try{
				...
				this.m_selectedSubscriptionItemListView.SubItems[3].Text = ((ControlDaSubscription)this.subscriptionsList.SelectedItems[0].Tag).ItemList.Length.ToString();
			}catch(Exception exc){
		...
		private uint RemoveItemsFromSelectedSubscription(DaAddressSpaceElement anAddressSpaceElement) {
			try {
				...
				DaAddressSpaceElement[] addressSpaceElements = null;
				if (ResultCode.SUCCEEDED(m_session.Browse(anAddressSpaceElement.ItemId, browseOptions, out addressSpaceElements, m_executionOptions))) {
					for (int i = 0; i < addressSpaceElements.Length; i++) {
						string itemID = addressSpaceElements[i].ItemId;
				...
				m_instance.Trace(EnumTraceLevel.ERR,EnumTraceGroup.CLIENT,"InfoCollector.RemoveItemsFromSelectedSubscription", exc.ToString());			
			}
			return 0;
		}
		/// <summary>
		...
		private bool AddressSpaceElementHasItems(DaAddressSpaceElement anAddressSpaceElement){
			try{
				...
				m_session.Browse(anAddressSpaceElement.ItemId,browseOptions,out addressSpaceElements,options);
				if (addressSpaceElements == null){ 
					return false;
				}	
			}catch(Exception exc){
				m_instance.Trace(EnumTraceLevel.ERR,EnumTraceGroup.CLIENT,"InfoCollector.AddressSpaceElementsHasItems", exc.ToString());
		...
		private void RefreshBrowseItemsTreeView(){
			...
			try{
				...
				if ((m_session.CurrentState == EnumObjectState.CONNECTED)||(m_session.CurrentState == EnumObjectState.ACTIVATED)) {
					...
					browseOptions.ElementTypeFilter = EnumAddressSpaceElementType.BRANCH;
					DaAddressSpaceElement[] addressSpaceElements = null;
					if (ResultCode.SUCCEEDED(m_session.Browse(String.Empty, browseOptions, out addressSpaceElements, m_executionOptions))) {
						for (int i = 0; i < addressSpaceElements.Length; i++) {
				...
				m_instance.Trace(EnumTraceLevel.ERR,EnumTraceGroup.CLIENT,"InfoCollector.RefreshBrowseItemsTreeView", exc.ToString());			
			}
		}
		...
		private void RefreshSubscribedItemsListView(){
			...
			try{
				...
				m_instance.Trace(EnumTraceLevel.ERR,EnumTraceGroup.CLIENT,"InfoCollector.RefreshSubscribedItemsListView", exc.ToString());			
			}
		}
				...
				if(aSession == null){					
					...
					if (aSession.StoredUrl == string.Empty){
						...
						if (m_initialSession.Valid){
							...
							m_instance.Trace( EnumTraceLevel.ERR, EnumTraceGroup.CLIENT, " InfoCollectorConstructor", "Failed to add initial session to the application");
						}
						#endregion
												
					}//end if...else reload configuration

					m_session.m_designTimeLicenseDa	   = aSession.m_designTimeLicenseDa;
					m_session.m_designTimeLicenseXmlDa = aSession.m_designTimeLicenseXmlDa;
					
					if(m_session.m_designTimeLicenseDa != string.Empty){
						m_instance.Activate(EnumFeature.DA_CLIENT, m_session.m_designTimeLicenseDa);
					}	//	end if
					
					if(m_session.m_designTimeLicenseXmlDa != string.Empty){
						m_instance.Activate(EnumFeature.XMLDA_CLIENT, m_session.m_designTimeLicenseXmlDa);
					}	//	end if
		...
		private void InitializeComponent() {
			...
			// serverPageOkButton
			// 
			this.serverPageOkButton.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
			...
			// 
			this.serverPageCancelButton.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
			...
			// 
			this.browseServersTreeView.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
			...
			this.browseServersTreeView.AfterSelect += new System.Windows.Forms.TreeViewEventHandler(this.browseServersTreeView_AfterSelect);
			this.browseServersTreeView.BeforeExpand += new System.Windows.Forms.TreeViewCancelEventHandler(this.browseServersTreeView_BeforeExpand);
			// 
			// itemsPage
			// 
			...
			// browseItemsGroupBox
			// 
			this.browseItemsGroupBox.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right)));
			...
			// itemsTreeView
			// 
			this.itemsTreeView.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Left | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.itemsTreeView.BeforeExpand += new System.Windows.Forms.TreeViewCancelEventHandler(this.itemsTreeView_BeforeExpand);
			// 
			// okFinalButton
			// 
			this.okFinalButton.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
			...
			// 
			this.removeSubscribedItemButton.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			...
			// 
			this.subscribedItemsListView.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
				| System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right)));
			...
			// 
			this.addSubscribedItemButton.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			...
			// 
			this.SubscriptionsGroupBox.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
				| System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right)));
			...
			// subscriptionsList
			// 
			this.subscriptionsList.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right)));
		...
		private void browseServersTreeView_BeforeExpand(object sender, System.Windows.Forms.TreeViewCancelEventArgs e) {
			try{
				...
				m_instance.Trace(EnumTraceLevel.ERR,EnumTraceGroup.CLIENT,"InfoCollector.browseServersTreeView_BeforeExpand", exc.ToString());			
			}
		}
							...
							switch(System.Windows.Forms.MessageBox.Show(
								...
								case(DialogResult.Yes):									
									...
									if (m_session.Valid) {
										...
										m_instance.Trace(EnumTraceLevel.ERR, EnumTraceGroup.CLIENT,"tabControl1_Click,is first time, is reload","Add DaSession failed!");
										m_isFirstTime = false;
										return;
									 }
									#endregion
						...
						switch(System.Windows.Forms.MessageBox.Show(
							...
							case(DialogResult.Yes):
								...
								if (m_session.Valid){
									...
									m_instance.Trace(EnumTraceLevel.ERR, EnumTraceGroup.CLIENT,"tabControl1_Click,is not first time","Add session failed!");
									return;
								 }
								//-
								#endregion
			...
			try{
				...
				if (e.Node.Nodes != null) {
					foreach (TreeNode rootNode in e.Node.Nodes) {
						...
						browseOptions.ElementTypeFilter = EnumAddressSpaceElementType.BRANCH;
						DaAddressSpaceElement[] addressSpaceElements = null;
						if (ResultCode.SUCCEEDED(m_session.Browse(((DaAddressSpaceElement)rootNode.Tag).ItemId, browseOptions, out addressSpaceElements, m_executionOptions))) {
				...
				m_instance.Trace(EnumTraceLevel.ERR,EnumTraceGroup.CLIENT,"InfoCollector.itemsTreeView_BeforeExpand", exc.ToString());			
			}
		}
		...
		private void itemsTreeView_AfterSelect(object sender, System.Windows.Forms.TreeViewEventArgs e) {
			try{
				...
				ListViewItem item;
				if (ResultCode.SUCCEEDED(m_session.Browse(((DaAddressSpaceElement)e.Node.Tag).ItemId, browseOptions, out addressSpaceElements, m_executionOptions))) {
					for (int i = 0; i < addressSpaceElements.Length; i++) {
				...
				m_instance.Trace(EnumTraceLevel.ERR,EnumTraceGroup.CLIENT,"InfoCollector.itemsTreeView_AfterSelect", exc.ToString());			
			}
		}
