...
//                             OPC Toolbox .NET                               |
//                                                                            |
//  Filename    : ClientDataElements.cs                                       |
//  Version     : 4.22.release                                                |
//  Date        : 15-December-2008                                            |
//                                                                            |
//  Description : - ControlDaSession - DA Session used in a DataControl       |
//						context												  |	
//				  - ControlDaSubscription - DA Subscription used in a		  |
//						DataControl context									  |
//				  - ControlDaItem - DA Item used in a DataControl context     |
//                                                                            |
//-----------------------------------------------------------------------------
...
namespace Softing.OPCToolbox.Client.Control {
	...
	public class ControlDaSession : DaSession {
		...
		/// <summary>
        /// A DA design time license.
        /// </summary>		
		/// <include 
		///  file='TBNC.doc.xml' 
		///  path='//class[@name="ControlDaSession"]/field[@name="m_designTimeLicenseDa"]/doc/*'
		/// />
		internal string m_designTimeLicenseDa = string.Empty;
		/// <summary>
        /// A XML-DA design time license.
        /// </summary>
		/// <include 
		///  file='TBNC.doc.xml' 
		///  path='//class[@name="ControlDaSession"]/field[@name="m_designTimeLicenseXmlDa"]/doc/*'
		/// />
		internal string m_designTimeLicenseXmlDa = string.Empty;
		...
		protected ControlDaSession(SerializationInfo info,StreamingContext context):
			...
			m_designTimeLicenseDa = info.GetString("m_designTimeLicenseDa");
			m_designTimeLicenseXmlDa = info.GetString("m_designTimeLicenseXmlDa");
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context){
			...
			info.AddValue("m_designTimeLicenseDa",m_designTimeLicenseDa);
			info.AddValue("m_designTimeLicenseXmlDa",m_designTimeLicenseXmlDa);
		}	
		#endregion
