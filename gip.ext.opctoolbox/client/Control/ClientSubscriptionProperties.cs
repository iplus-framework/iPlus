...
//                             OPC Toolbox .NET                               |
//                                                                            |
//  Filename    : ClientSubscriptionProperties.cs                             |
//  Version     : 4.22.release                                                |
//  Date        : 15-December-2008                                            |
//                                                                            |
//  Description : Object to collect data on a new or an existing subscription |
//                                                                            |
//-----------------------------------------------------------------------------
...
namespace Softing.OPCToolbox.Client.Control
{
	...
	public class SubscriptionProperties : System.Windows.Forms.Form
	{
		...
		internal bool IsAddingSubscription{
			get{
				return m_isAddingSubscription;
			}
			set{
				m_isAddingSubscription = value;
			}
		}

		internal bool IsEditingSubscription{
			get{
				return m_isEditingSubscription;
			}
			set{
				m_isEditingSubscription = value;
			}
		}
		//-
		#endregion		
		...
		private void InitializeComponent()
		{
			...
			// 
			this.subscriptionNameTextBox.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
			...
			// 
			this.subscriptionUpdateRateTextBox.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right)));
			...
			try{
				...
				if (subscriptionNameTextBox.Text != string.Empty){
					...
					foreach(ControlDaSubscription subscription in m_session.SubscriptionList){
						if ((subscription.StoredName == subscriptionNameTextBox.Text) && (subscription.GetHashCode() != currentSelectedSubscription.GetHashCode()))
						{
							found = true;
						}//end if
					}//end foreach
					if(found){
						MessageBox.Show("The server already has a subscription named " + subscriptionNameTextBox.Text + "!Please introduce a different subscription name.",
							"Warning");
                        return;
					}//end if
				}//end if
