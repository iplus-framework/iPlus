...
//                             OPC Toolbox .NET                               |
//                                                                            |
//  Filename    : ServerAddressSpaceElement.cs                                |
...
namespace Softing.OPCToolbox.Server{
	...
	/// </para>
	/// <para lang="Visual Basic, C#, C++"> Delegate to be called when a new element was added to the address space.</para>
	/// </summary>	
	/// <remarks>
	/// <para lang="Visual Basic, C#, C++"> For the the default behavior no delegate is associated to the address space element event
	...
	/// </para>
	/// <para lang="Visual Basic, C#, C++"> Delegate to be called when a new element was removed from the address space.</para>
	/// </summary>	
	/// <remarks>	
	/// <para lang="Visual Basic, C#, C++"> For the the default behavior no delegate is associated to the address space element event
	...
	public abstract class AddressSpaceElement : IAddressSpaceElement{
		...
		/// <param name="anObjectHandle">Toolbox internal identifier of the element</param>
		/// <param name="aParentHandle">Toolbox internal identifier of the element's parent</param>
		/// <include
		///		file='TBNS.doc.xml' 
		...
		/// OTB handler
		/// </summary>
		protected internal IntPtr m_objectHandle = IntPtr.Zero;

		/// <summary>
		/// OTB parent handler
		/// </summary>
		protected internal IntPtr m_parentHandle = IntPtr.Zero;
	...
	public abstract class AddressSpaceRoot : IAddressSpaceElement{
		...
		/// <returns>
		/// Success of failure result code
		...
		/// </summary>
		internal AddressSpaceElement GetParent(IntPtr aHandle){
		...
		internal virtual uint AddElementToArray(AddressSpaceElement anElement) {
			...
			Hashtable synchronizedElements = Hashtable.Synchronized(this.m_elements);			
			synchronizedElements.Add(anElement.UserData, anElement);			
		...
		internal virtual int RemoveElementFromArray(uint anElementUserData) {
			...
			try{
				Hashtable synchronizedElements = Hashtable.Synchronized(this.m_elements);
				synchronizedElements.Remove(anElementUserData);
		...
		///		file='TBNS.doc.xml' 
		///			path='//class[@name="AddressSpaceRoot"]/
		///			method[@name="m_namespaceType"]/doc/*'
		///	/>
