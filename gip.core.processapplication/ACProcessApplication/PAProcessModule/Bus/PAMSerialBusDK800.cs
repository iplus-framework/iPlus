...
{
    [ACClassInfo(Const.PackName_VarioAutomation, "en{'Serial Bus DK800'}de{'Serieller Bus DK800'}", Global.ACKinds.TPAProcessModule, Global.ACStorableTypes.Required, false, PWGroup.PWClassName, true)]
