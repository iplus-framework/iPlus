...
namespace gip.core.processapplication
{
    ...
    /// </summary>
    [ACClassInfo(Const.PackName_VarioAutomation, "en{'2-Way Actuator analog'}de{'2-Wege Stellglied Analog'}", Global.ACKinds.TPAModule, Global.ACStorableTypes.Required, false, true)]
