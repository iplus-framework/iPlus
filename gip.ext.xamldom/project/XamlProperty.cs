...
namespace gip.ext.xamldom
{
    ...
    public sealed class XamlProperty
    {
            ...
            : this(parentObject, propertyInfo)
        {
            ...
            // Test:
            //if ((parentObject.Instance is SetterBase) || (parentObject.Instance is TriggerBase) || (parentObject.Instance is EventTrigger) || (parentObject.Instance is System.Windows.Media.Animation.Storyboard) || (parentObject.Instance is Condition))
            //{
            //    int i = 0;
            //    i++;
            //}
        ...
        public object ValueOnInstance
        {
            get
            {
                if (IsEvent)
                {
                    if (propertyValue != null)
                    {
                        if ((propertyValue is XamlObject) && ((propertyValue as XamlObject).Instance is MarkupExtension))
        ...
        public bool IsDependencyProperty
        {
            get
            {
                return ((propertyInfo is XamlDependencyPropertyInfo) || (propertyInfo.DependencyProperty != null));
            }
        }
