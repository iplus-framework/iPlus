...
namespace gip.ext.chart.avui
{
	public class GenericChartPlotter<THorizontal, TVertical> : ChartPlotter
	{
		...
		protected override void ValidateHorizontalAxis(IAxis axis)
		{
			...
			{
                throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, gip.ext.chart.avui.Properties.Resources.InvalidGenericAxis, GetType().Name, typeof(THorizontal).Name));
			}
		...
		protected override void ValidateVerticalAxis(IAxis axis)
		{
			...
			{
                throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, gip.ext.chart.avui.Properties.Resources.InvalidGenericAxis, GetType().Name, typeof(TVertical).Name));
			}
