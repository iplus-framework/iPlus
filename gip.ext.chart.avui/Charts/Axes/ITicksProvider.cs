...
namespace gip.ext.chart.avui.Charts
{
	...
	[DebuggerDisplay("TicksInfo Count={tickSizes.Length}")]
	...
	public interface ITicksProvider<T>
	{
		...
		/// Returned value should be later passed as ticksCount parameter in GetTicks method.
		/// </summary>
		/// <param name="ticksCount">The ticks count.</param>
		/// <returns>New ticks count.</returns>
		...
		/// </summary>
		/// <value>The mayor provider.</value>
