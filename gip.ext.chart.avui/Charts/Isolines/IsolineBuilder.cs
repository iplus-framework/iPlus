...
namespace gip.ext.chart.avui.Charts.Isolines
{
	/// <summary>
	...
	public sealed class IsolineBuilder
	{
		...
		private Edge GetOutEdge(Edge inEdge, ValuesInCell cv, IrregularCell rect, double value)
		{
			...
			{
                throw new IsolineGenerationException(gip.ext.chart.avui.Properties.Resources.IsolinesValueIsOutOfCell);
			}
			...
			switch (inEdge)
			{
				case Edge.Left:
					if (value == lt)
                        ...
                        throw new IsolineGenerationException(gip.ext.chart.avui.Properties.Resources.IsolinesUnsupportedCase);
					break;
				case Edge.Top:
					if (value == rt)
						value = near_one * rt + near_zero * lt;
		...
		private Edge GetOutForOpposite(Edge inEdge, CellBitmask cellVal, double value, ValuesInCell cellValues, IrregularCell rect)
		{
            ...
            throw new IsolineGenerationException(gip.ext.chart.avui.Properties.Resources.IsolinesDataIsUndetailized);
		}
		...
		{
			if (dataSource == null)
                throw new InvalidOperationException(gip.ext.chart.avui.Properties.Resources.IsolinesDataSourceShouldBeSet);
		}
