...
namespace gip.ext.chart.avui.Navigation
{
	...
	public class DefaultContextMenu : IPlotterElement
	{
		...
		private static BitmapImage LoadIcon(string name)
		{
			...
			icon.BeginInit();
			icon.StreamSource = currentAssembly.GetManifestResourceStream("gip.ext.chart.avui.Resources." + name + ".png");
			icon.EndInit();
			icon.Freeze();
		...
		protected ContextMenu PopulateContextMenu(IInputElement target)
		{
			...
			{
                Header = gip.ext.chart.avui.Properties.Resources.ContextMenuFitToView,
                ToolTip = gip.ext.chart.avui.Properties.Resources.ContextMenuFitToViewTooltip,
			...
			{
                Header = gip.ext.chart.avui.Properties.Resources.ContextMenuSaveScreenshot,
                ToolTip = gip.ext.chart.avui.Properties.Resources.ContextMenuSaveScreenshotTooltip,
			...
			{
                Header = gip.ext.chart.avui.Properties.Resources.ContextMenuCopyScreenshot,
                ToolTip = gip.ext.chart.avui.Properties.Resources.ContextMenuCopyScreenshotTooltip,
			...
			{
                Header = gip.ext.chart.avui.Properties.Resources.ContextMenuQuickHelp,
                ToolTip = gip.ext.chart.avui.Properties.Resources.ContextMenuQuickHelpTooltip,
		...
		private void plotter_PreviewMouseRightButtonDown(object sender, MouseButtonEventArgs e)
		{
            ...
            {
                hitResults.Clear();
                VisualTreeHelper.HitTest(plotter, null, CollectAllVisuals_Callback, new PointHitTestParameters(mousePos));
