...
namespace gip.ext.chart.avui.Common.Palettes
{
	...
	public sealed class LinearPalette : IPalette, ISupportInitialize
	{
		...
		public LinearPalette(params Color[] colors)
		{
            ...
            if (colors.Length < 2) throw new ArgumentException(gip.ext.chart.avui.Properties.Resources.PaletteTooFewColors);
