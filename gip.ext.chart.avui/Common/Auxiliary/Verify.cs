...
namespace gip.ext.chart.avui.Common.Auxiliary
{
	internal static class Verify
	{
		...
		public static void IsTrue(this bool condition)
		{
			if (!condition)
			{
                throw new ArgumentException(gip.ext.chart.avui.Properties.Resources.AssertionFailedSearch);
			}
		}
		...
		public static void IsTrue(this bool condition, string paramName)
		{
			if (!condition)
			{
                throw new ArgumentException(gip.ext.chart.avui.Properties.Resources.AssertionFailedSearch, paramName);
			}
		}
