...
// ***********************************************************************
// <copyright file="ACClassPropertyInfo.cs" company="gip mbh, Oftersheim, Germany">
...
namespace gip.core.datamodel
{
    ...
    /// </summary>
    [ACClassInfo(Const.PackName_VarioSystem, "en{'Rightiteminfo Property'}de{'Rechteinfo Eigenschaft'}", Global.ACKinds.TACClass, Global.ACStorableTypes.NotStorable, true, false)]
    [ACQueryInfoPrimary(Const.PackName_VarioSystem, Const.QueryPrefix + "ACClassPropertyInfo", "en{'ACClassPropertyInfo'}de{'ACClassPropertyInfo'}", typeof(ACClassPropertyInfo), "ACClassPropertyInfo", "ValueT\\ACIdentifier", "ValueT\\ACIdentifier")]
    public class ACClassPropertyInfo : IACContainerT<ACClassProperty>, INotifyPropertyChanged, IACObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ACClassPropertyInfo"/> class.
        /// </summary>
        public ACClassPropertyInfo()
        {
        }
        ...
        [ACPropertyInfo(9999, "", "", Const.ContextDatabase + "\\PropertyControlModeList")]
        ...
        /// <value>The encapsulated ACClassProperty</value>
        [ACPropertyInfo(9999)]
        public ACClassProperty ValueT
        {
            get
            {
                return _ValueT;
