...
databaseConnectionString='data source=gipDLVmSQL1.incus;Initial Catalog=iPlusV5;Trusted_Connection=False;Encrypt=False;user id=gip;password=netspirit;'
...
# 2. Update ConfigureWarnings (remove semicolon matches PS script behavior)
...
# Note: Using | as delimiter to avoid escaping complications
...
# Matches start of line indentation, then the UseSqlServer part.
