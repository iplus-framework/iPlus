...
namespace gip.core.datamodel
{
    ...
    [ACPropertyEntity(7, nameof(SortIndex), "en{'Sortindex'}de{'Sortierung'}", "", "", true)]
    [ACPropertyEntity(8, nameof(IsCommand), "en{'Command Method'}de{'Kommando Methode'}", "", "", true)]
    [ACPropertyEntity(9, nameof(IsInteraction), "en{'Interaction Method'}de{'Interaktions Methode'}", "", "", true)]
    [ACPropertyEntity(10, nameof(IsAsyncProcess), "en{'Async.Process Method'}de{'Async.Prozess Methode'}", "", "", true)]
    [ACPropertyEntity(11, nameof(IsPeriodic), "en{'Periodic'}de{'Periodisch'}", "", "", true)]
    [ACPropertyEntity(12, nameof(IsRightmanagement), "en{'Rights Management'}de{'Rechteverwaltung'}", "", "", true)]
    [ACPropertyEntity(13, nameof(IsAutoenabled), "en{'Autoenabled'}de{'Autom.Aktiv'}", "", "", true)]
    [ACPropertyEntity(14, nameof(IsSubMethod), "en{'Submethod'}de{'Untermethode'}", "", "", true)]
    ...
    [ACPropertyEntity(21, nameof(AttachedFromACClass), "en{'Attached from Class'}de{'Angehängt von der Klasse'}", Const.ContextDatabaseIPlus + "\\" + ACClass.ClassName, "", true)]
    ...
    [ACPropertyEntity(9999, nameof(PWACClass), "en{'Workflowclass'}de{'Workflowklasse'}", Const.ContextDatabaseIPlus + "\\PWNodeList", "", true)]
    [ACPropertyEntity(9999, nameof(Sourcecode), "en{'Sourcecode'}de{'Quellcode'}", "", "", true)]
    [ACPropertyEntity(9999, nameof(InteractionVBContent), "en{'Interaction Content'}de{'Interaktionsinhalt'}", "", "", true)]
    [ACPropertyEntity(9999, nameof(ValueTypeACClass), "en{'Data Type'}de{'Datentyp'}", Const.ContextDatabaseIPlus + "\\" + ACClass.ClassName, "", true)]
    [ACPropertyEntity(9999, nameof(ACClassMethod1_ParentACClassMethod), "en{'Parent Method'}de{'Elternmethode'}", Const.ContextDatabaseIPlus + "\\" + ACClassMethod.ClassName, "", true)]
    ...
    public partial class ACClassMethod : IACObjectEntityWithCheckTrans, IACEntityProperty, IACWorkflowDesignContext, IACType, IACClassEntity, IACConfigStore, ICloneable, IInsertInfo, IUpdateInfo
    {
        ...
        public IEnumerable<IACConfig> GetConfigListOfType(IACObjectEntity acObject = null)
        {
            ...
            if (acClassMethod != this)
            {
                ...
                {
                    if (acClassMethod.ACClassMethodConfig_ACClassMethod.IsLoaded && !acClassMethod.Database.IsChanged)
                    {
