...
namespace gip.ext.designer.avui.Services
{
    ...
    /// </summary>
    class DefaultSelectionService : ISelectionService, INotifyPropertyChanged
    {
        ...
        public DesignItem TemporarySelectionFromTreeView
        {
            get;
            set;
        }
        ...
        public void SelectionFromTreeView(DesignItem component)
        {
            TemporarySelectionFromTreeView = component;
            SetSelectedComponents(new DesignItem[] { component });
        }
        ...
        public void SetSelectedComponents(ICollection<DesignItem> components, SelectionTypes selectionType, IDrawingTool drawingTool)
        {
            if (drawingTool is DrawingToolEditPoints)
                SetSelectedComponents(components, SelectionTypes.Primary);
            else
                SetSelectedComponents(components, selectionType);
        }
        ...
        public void SetSelectedComponents(ICollection<DesignItem> components, SelectionTypes selectionType)
        {
            ...
            {
                // TODO: How can Keyboard be accessed?
