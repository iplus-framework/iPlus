...
namespace gip.core.webservices
{
    ...
    public class ACPropertyJsonConverter<T> : JsonConverter<T>, IACPropertyJsonConverter where T : IACObjectKeyComparer
    {
        ...
        public ushort DetailLevel
        {
            ...
            set
            {
                if (value > MCPToolBase.DetailLevel_UserDefined)
        ...
        public override void Write(Utf8JsonWriter writer, T value, JsonSerializerOptions options)
        {
            ...
            foreach (var property in properties)
            {
                ...
                if (DetailLevel == MCPToolBase.DetailLevel_UserDefined && RequestedFields != null && RequestedFields.Count() > 0)
                {
                ...
                gip.core.datamodel.ACClassProperty acPropertyInfo = null;
        ...
        private HashSet<string> GetUserDefinedFields(JsonSerializerOptions options, List<KeyValuePair<string, object>> parametersKVP)
        {
            ...
            if (detailLevel != MCPToolBase.DetailLevel_UserDefined || parametersKVP == null)
                return null;
        ...
        private bool ShouldIncludePropertyByDetailLevel(PropertyInfo property, gip.core.datamodel.ACClassProperty acPropertyInfo, ushort detailLevel, bool isNavigationProp, bool isCollection, int currentDepth)
        {
            switch (detailLevel)
            {
                case MCPToolBase.DetailLevel_Minimal:
                    return currentDepth <= 1 && !isNavigationProp && (acPropertyInfo != null && acPropertyInfo.SortIndex < 10);

                case MCPToolBase.DetailLevel_FirstDegree:
                ...
                case MCPToolBase.DetailLevel_Complete:
                    return currentDepth <= 3; // Prevent infinite recursion

                case MCPToolBase.DetailLevel_UserDefined: // User-defined - handled separately
                    return true;
        ...
        private void WriteComplexProperty(Utf8JsonWriter writer, string propertyName, object value, JsonSerializerOptions options, ushort detailLevel)
        {
            ...
            if ((detailLevel == MCPToolBase.DetailLevel_Minimal && writer.CurrentDepth >= 2) ||
                (detailLevel == MCPToolBase.DetailLevel_FirstDegree && writer.CurrentDepth >= 3) ||
        ...
        private void WriteCollectionProperty(Utf8JsonWriter writer, string propertyName, object value, gip.core.datamodel.ACClassProperty acPropertyInfo, JsonSerializerOptions options, ushort detailLevel)
        {
            if (value == null)
            {
                writer.WriteNull(propertyName);
            ...
            if ((detailLevel == MCPToolBase.DetailLevel_Minimal && writer.CurrentDepth >= 1) ||
                (detailLevel == MCPToolBase.DetailLevel_FirstDegree && writer.CurrentDepth >= 2) ||
            ...
            if (value is IEnumerable enumerable)
            {
                ...
                {
                    MCPToolBase.DetailLevel_Minimal => 3,  // Minimal - very few items
                    MCPToolBase.DetailLevel_FirstDegree => 10, // First-degree - moderate items
                    MCPToolBase.DetailLevel_Complete => 100, // Complete - many items
                    3 => 100, // User-defined - moderate items
                    _ => 100
                };
