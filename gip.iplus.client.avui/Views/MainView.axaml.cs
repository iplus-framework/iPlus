...
public partial class MainView : UserControl, IRootPageWPF, IFocusChangeListener
{
    ...
    public async Task<Global.MsgResult> ShowMsgBoxAsync(Msg msg, Global.MsgResult defaultResult, eMsgButton msgButton)
    {
        ...
        // Das findet man �ber den Zugriff auf eine interne Member heraus:
...
#pragma warning restore VSTHRD002
    ...
    #region Blidschirm f�r n�chsten Start einfrieren
    ...
    private async Task WarningIcon_DoubleTappedAsync()
    {
        ...
        {
            Task task = bsoAlarmExplorer.ACUrlCommand("!ShowAlarmExplorer") as Task;
            if (task != null)
                await task;
