    ...
    public class DrawingToolEditPoints : DrawingTool
    {
        ...
        public override void OnMouseDown(object sender, MouseButtonEventArgs e)
        {
            ...
            if (Keyboard.IsKeyDown(Key.LeftCtrl))
            {
                ...
                if (result1.ModelHit != null && result1.VisualHit != null && result1.VisualHit is gip.ext.graphics.shapes.ArrowPolyline)
                {
                    var polyline = result1.VisualHit as gip.ext.graphics.shapes.ArrowPolyline;
                    if (polyline != null)
                        polyline.InsertPoint(e.GetPosition(polyline));

                    design.Adorners.AdornerPanel adornerPanel = null;
                    ...
                    if (adornerPanel != null)
                    {
                        ...
                        foreach (Point point in polyline.Points)
                        {
                            ...
                            design.Adorners.AdornerPanel.SetPlacement(adorner, new ShapePointsAdornerProvider.ShapePointsAdornerPlacement(polyline as Shape, point));
