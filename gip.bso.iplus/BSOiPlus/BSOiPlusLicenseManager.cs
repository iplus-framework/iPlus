...
namespace gip.bso.iplus
{
    ...
    public sealed class BSOiPlusLicenseManager : ACBSONav
    {
        ...
        public string UniqueCustomerCode
        {
            get
            {
                return _UniqueCustomerCode;
            }
            set
            {
                _UniqueCustomerCode = value;
        ...
        private void LoadAvailableAssignedPackages()
        {
            ...
            else
            {
                ...
                var assignedPackages = Encoding.UTF8.GetString(CurrentVBLicense.PackageSystem).Split(',');
