...
namespace gip.ext.design.avui
{
	public static class MouseHorizontalWheelEnabler
	{
		...
		private static IntPtr? GetObjectParentHandle(AvaloniaObject depObj)
		{
			...
			//var presentationSource = PresentationSource.FromAvaloniaObject(depObj) as HwndSource;
		...
		public static void EnableMouseHorizontalWheelSupportForParentOf(Control uiElement)
		{
		...
		private static void HandleMouseHorizontalWheel(IntPtr wParam)
		{
			...
			//{
			//	element = UIHelpers.FindAncestor<UIElement>(element as AvaloniaObject);
			//}
			//if (element == null)
			//{
			//	return;
		...
		//public static void AddMouseHorizontalWheelHandler(AvaloniaObject d, RoutedEventHandler handler)
		//{
		...
		//public static void RemoveMouseHorizontalWheelHandler(AvaloniaObject d, RoutedEventHandler handler)
		//{
		//	var uie = d as UIElement;
		...
		//public static void AddPreviewMouseHorizontalWheelHandler(AvaloniaObject d, RoutedEventHandler handler)
		//{
		//	var uie = d as UIElement;
		//	if (uie != null)
		//	{
		...
		//public static void RemovePreviewMouseHorizontalWheelHandler(AvaloniaObject d, RoutedEventHandler handler)
		//{
		//	var uie = d as UIElement;
