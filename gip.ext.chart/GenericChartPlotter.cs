...
namespace gip.ext.chart
{
	public class GenericChartPlotter<THorizontal, TVertical> : ChartPlotter
	{
		...
		protected override void ValidateHorizontalAxis(IAxis axis)
		{
			...
			{
                throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, gip.ext.chart.Properties.Resources.InvalidGenericAxis, GetType().Name, typeof(THorizontal).Name));
			}
		...
		protected override void ValidateVerticalAxis(IAxis axis)
		{
			...
			{
                throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, gip.ext.chart.Properties.Resources.InvalidGenericAxis, GetType().Name, typeof(TVertical).Name));
			}
