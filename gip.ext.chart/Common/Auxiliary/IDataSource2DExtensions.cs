...
namespace gip.ext.chart.Common.Auxiliary
{
	public static class IDataSource2DExtensions
	{
		public static Range<double> GetMinMax(this double[,] data)
		{
            ...
            Verify.IsTrueWithMessage(width > 0, gip.ext.chart.Properties.Resources.ArrayWidthShouldBePositive);
			Verify.IsTrueWithMessage(height > 0, gip.ext.chart.Properties.Resources.ArrayHeightShouldBePositive);
