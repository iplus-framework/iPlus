...
namespace gip.ext.chart
{
	public abstract class PointsGraphBase : ViewportElement2D, IOneDimensionalChart
	{
		...
		public IPointDataSource DataSource
		{
			get 
            {
                /*return (IPointDataSource)this.Dispatcher.Invoke(
                       System.Windows.Threading.DispatcherPriority.Background,
                       (System.Windows.Threading.DispatcherOperationCallback)delegate { return GetValue(DataSourceProperty); },
                       DataSourceProperty);*/
                return (IPointDataSource)GetValue(DataSourceProperty); 
            }
		...
		protected virtual void OnDataChanged()
		{
            ...
            {
                this.Dispatcher.BeginInvoke(DispatcherPriority.Background, new Action(OnDataChanged));
            }
            else
            {
