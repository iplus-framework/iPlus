...
namespace gip.ext.chart.Navigation
{
	...
	public class DefaultContextMenu : IPlotterElement
	{
		...
		private static BitmapImage LoadIcon(string name)
		{
			...
			icon.BeginInit();
			icon.StreamSource = currentAssembly.GetManifestResourceStream("gip.ext.chart.Resources." + name + ".png");
			icon.EndInit();
			icon.Freeze();
		...
		protected ContextMenu PopulateContextMenu(IInputElement target)
		{
			...
			{
                Header = gip.ext.chart.Properties.Resources.ContextMenuFitToView,
                ToolTip = gip.ext.chart.Properties.Resources.ContextMenuFitToViewTooltip,
			...
			{
                Header = gip.ext.chart.Properties.Resources.ContextMenuSaveScreenshot,
                ToolTip = gip.ext.chart.Properties.Resources.ContextMenuSaveScreenshotTooltip,
			...
			{
                Header = gip.ext.chart.Properties.Resources.ContextMenuCopyScreenshot,
                ToolTip = gip.ext.chart.Properties.Resources.ContextMenuCopyScreenshotTooltip,
			...
			{
                Header = gip.ext.chart.Properties.Resources.ContextMenuQuickHelp,
                ToolTip = gip.ext.chart.Properties.Resources.ContextMenuQuickHelpTooltip,
