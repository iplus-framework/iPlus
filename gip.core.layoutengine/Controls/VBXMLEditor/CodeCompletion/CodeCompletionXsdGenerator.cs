...
namespace gip.core.layoutengine
{
    ...
    public class CodeCompletionXsdGenerator
    {
        ...
        internal static string vbSchemaPath = @"\gip.core.layoutengine\VBXMLEditorSchemas\VBSchema.xsd";
        internal static string msSchemaPath = @"\gip.core.layoutengine\VBXMLEditorSchemas\XamlPresentation2006.xsd";
                            ...
                            Func<XmlSchemaElement, Type, bool> typeSpecFunc, string currentSchemaPath, string itemPrefix = "", string customAttCheck = "")
        {
            ...
            foreach (var depType in depenTypes)
            {
                ...
                else if (baseType != null && baseType.Assembly.FullName.StartsWith("gip.core.layoutengine"))
                {
                    XmlSchemaComplexContentExtension cmxContentExt = new XmlSchemaComplexContentExtension();
    ...
    public class CodeCompletionXsdGeneratorVB : MarshalByRefObject
    {
        ...
        public void RunTool()
        {
            ...
            gen.RunTool("gip.core.layoutengine", CodeCompletionXsdGenerator.vbNs, new Type[] { typeof(DependencyObject), typeof(MarkupExtension) }, importSchemaList, "VBControls",
