    ...
    public class TimelineItemsPresenter : ItemsControl
    {
        ...
        private static List<CustomControlStyleInfo> _styleInfoList = new List<CustomControlStyleInfo> { 
            new CustomControlStyleInfo { wpfTheme = eWpfTheme.Gip, 
                                         ...
                                         styleUri = "/gip.core.layoutengine;Component/Controls/VBTimeline/Themes/TimelineItemsPresenterStyleGip.xaml" },
            new CustomControlStyleInfo { wpfTheme = eWpfTheme.Aero, 
                                         styleName = "TimelineItemsPresenterStyleAero", 
                                         styleUri = "/gip.core.layoutengine;Component/Controls/VBTimeline/Themes/TimelineItemsPresenterStyleAero.xaml" },
        };
        /// <summary>
