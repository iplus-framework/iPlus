    ...
    public class TimelineItem : TimelineItemBase
    {
        ...
        private static List<CustomControlStyleInfo> _styleInfoList = new List<CustomControlStyleInfo> { 
            new CustomControlStyleInfo { wpfTheme = eWpfTheme.Gip, 
                                         ...
                                         styleUri = "/gip.core.layoutengine;Component/Controls/VBTimeline/Themes/TimelineItemStyleGip.xaml" },
            new CustomControlStyleInfo { wpfTheme = eWpfTheme.Aero, 
                                         styleName = "TimelineItemStyleAero", 
                                         styleUri = "/gip.core.layoutengine;Component/Controls/VBTimeline/Themes/TimelineItemStyleAero.xaml" },
        };
        /// <summary>
