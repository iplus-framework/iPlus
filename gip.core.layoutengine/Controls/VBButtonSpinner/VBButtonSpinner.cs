    ...
    public class VBButtonSpinner : Spinner
    {
        private static List<CustomControlStyleInfo> _styleInfoList = new List<CustomControlStyleInfo> { 
            new CustomControlStyleInfo { wpfTheme = eWpfTheme.Gip, 
                                         ...
                                         styleUri = "/gip.core.layoutengine;Component/Controls/VBButtonSpinner/Themes/ButtonSpinnerStyleGip.xaml" },
            new CustomControlStyleInfo { wpfTheme = eWpfTheme.Aero, 
                                         styleName = "ButtonSpinnerStyleAero", 
                                         styleUri = "/gip.core.layoutengine;Component/Controls/VBButtonSpinner/Themes/ButtonSpinnerStyleAero.xaml" },
        };
        /// <summary>
