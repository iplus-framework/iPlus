    ...
    public class VBTreeListViewItem : VBTreeViewItem
    {
        ...
        private static List<CustomControlStyleInfo> _styleInfoList3 = new List<CustomControlStyleInfo> { 
            new CustomControlStyleInfo { wpfTheme = eWpfTheme.Gip, 
                                         ...
                                         styleUri = "/gip.core.layoutengine;Component/Controls/VBVBTreeListView/Themes/TreeListViewItemStyleGip.xaml" },
            new CustomControlStyleInfo { wpfTheme = eWpfTheme.Aero, 
                                         styleName = "TreeListViewItemStyleAero", 
                                         styleUri = "/gip.core.layoutengine;Component/Controls/VBVBTreeListView/Themes/TreeListViewItemStyleAero.xaml" },
        };
