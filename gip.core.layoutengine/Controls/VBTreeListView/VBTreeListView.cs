    ...
    public class VBTreeListView : VBTreeView
    {
        ...
        private static List<CustomControlStyleInfo> _styleInfoList2 = new List<CustomControlStyleInfo> { 
            new CustomControlStyleInfo { wpfTheme = eWpfTheme.Gip, 
                                         ...
                                         styleUri = "/gip.core.layoutengine;Component/Controls/VBTreeListView/Themes/TreeListViewStyleGip.xaml" },
            new CustomControlStyleInfo { wpfTheme = eWpfTheme.Aero, 
                                         styleName = "TreeListViewStyleAero", 
                                         styleUri = "/gip.core.layoutengine;Component/Controls/VBTreeListView/Themes/TreeListViewStyleAero.xaml" },
        };
