    ...
    public class VBConnector : Control, IVBConnector
    {
        ...
        private static List<CustomControlStyleInfo> _styleInfoList = new List<CustomControlStyleInfo> { 
            new CustomControlStyleInfo { wpfTheme = eWpfTheme.Gip, 
                                         ...
                                         styleUri = "/gip.core.layoutengine;Component/Controls/VBConnector/Themes/VBConnectorStyleGip.xaml" },
            new CustomControlStyleInfo { wpfTheme = eWpfTheme.Aero, 
                                         styleName = "VBConnectorStyleAero", 
                                         styleUri = "/gip.core.layoutengine;Component/Controls/VBConnector/Themes/VBConnectorStyleAero.xaml" },
        };
        /// <summary>
