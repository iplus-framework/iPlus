...
{ 
    ...
    public class VBAutoCompleteBox : VBListBox, IUpdateVisualState, IVBContent, IVBSource, IACObject
    {
        ...
        /// </summary>
        private WeakEventListener<VBAutoCompleteBox, object, NotifyCollectionChangedEventArgs>
        ...
        private static void OnMinimumPopulateDelayPropertyChanged(DependencyObject d,
            DependencyPropertyChangedEventArgs e)
        {
            var source = d as VBAutoCompleteBox;
            ...
            if (newValue < 0)
            {
                ...
                throw new ArgumentException("Invalid value: " + e.NewValue);
            }
        ...
        private static void OnSearchTextPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!source._allowWrite)
            {
                ...
                throw new InvalidOperationException("Invalid write.");
            }
        }
        ...
        public static readonly RoutedEvent TextChangedEvent = EventManager.RegisterRoutedEvent("TextChanged",
            RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(VBAutoCompleteBox));
        ...
        public static readonly RoutedEvent PopulatingEvent = EventManager.RegisterRoutedEvent("Populating",
            RoutingStrategy.Bubble, typeof(PopulatingEventHandler), typeof(VBAutoCompleteBox));
        ...
        public static readonly RoutedEvent PopulatedEvent = EventManager.RegisterRoutedEvent("Populated",
            RoutingStrategy.Bubble, typeof(PopulatedEventHandler), typeof(VBAutoCompleteBox));
        ...
        public static readonly RoutedEvent DropDownOpeningEvent = EventManager.RegisterRoutedEvent("DropDownOpening",
            RoutingStrategy.Bubble, typeof(RoutedPropertyChangingEventHandler<bool>), typeof(VBAutoCompleteBox));
        ...
        public static readonly RoutedEvent DropDownOpenedEvent = EventManager.RegisterRoutedEvent("DropDownOpened",
            RoutingStrategy.Bubble, typeof(RoutedPropertyChangedEventHandler<bool>), typeof(VBAutoCompleteBox));
        ...
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(VBAutoCompleteBox),
                new FrameworkPropertyMetadata(typeof(VBAutoCompleteBox)));
        }
        ...
        public override void OnApplyTemplate()
        {
            ...
            TextBox = GetTemplateChild(ElementTextBox) as VBTextBox;
        ...
        private void ClosingDropDown(bool oldValue)
        {
            ...
            var args = new RoutedPropertyChangingEventArgs<bool>(IsDropDownOpenProperty, oldValue, false, true,
        ...
        {
            var args = new RoutedPropertyChangingEventArgs<bool>(IsDropDownOpenProperty, oldValue, true, true,
        ...
        {
            //RaiseEvent(e);
            ListBox innerListBox = (ListBox)this.Template.FindName("Selector", this);
        ...
        protected override void OnItemsSourceChanged(IEnumerable oldValue, IEnumerable newValue)
        {
            ...
            {
                _collectionChangedWeakEventListener =
                    new WeakEventListener<VBAutoCompleteBox, object, NotifyCollectionChangedEventArgs>(this);
        ...
        protected override void InitVBControl()
        {
            ...
            SetBinding(SourceItemsProperty, binding);

            Binding binding2 = new Binding();
            binding2.Source = this;
            binding2.Path = new PropertyPath("VBAutoCompleteBoxItems");
            SetBinding(ItemsSourceProperty, binding2);

            Binding binding3 = new Binding();
            binding3.Source = dcSource;
            binding3.Path = new PropertyPath(dcPath);
            binding3.Mode = BindingMode.TwoWay;
            SetBinding(SelectedIACObjectProperty, binding3);

            ValueMemberPath = "CurrentItemCaption";

            if (BSOACComponent != null)
            {
                Binding binding4 = new Binding();
                binding4.Source = BSOACComponent;
                binding4.Path = new PropertyPath(Const.InitState);
                binding4.Mode = BindingMode.OneWay;
                SetBinding(VBAutoCompleteBox.ACCompInitStateProperty, binding4);
            }
        ...
        {
            get { return (IEnumerable<IACObject>)GetValue(SourceItemsProperty); }
            set { SetValue(SourceItemsProperty, value); }
        }

        // Using a DependencyProperty as the backing store for SourceItems.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty SourceItemsProperty =
            DependencyProperty.Register("SourceItems", typeof(IEnumerable<IACObject>), typeof(VBAutoCompleteBox), new PropertyMetadata(null, SourceItemsChanged));

        private static void SourceItemsChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            VBAutoCompleteBox me = d as VBAutoCompleteBox;
            if(me != null)
            {
                me.VBAutoCompleteBoxItems = me.GenerateVBAutoCompleteBoxItems(e.NewValue as IEnumerable<IACObject>);
            }
        }
        ...
        {
            get { return (IACObject)GetValue(SelectedIACObjectProperty); }
            set { SetValue(SelectedIACObjectProperty, value); }
        }

        // Using a DependencyProperty as the backing store for SelectedIACObject.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty SelectedIACObjectProperty =
            DependencyProperty.Register("SelectedIACObject", typeof(IACObject), typeof(VBAutoCompleteBox), new PropertyMetadata(null, OnSelectedIACObjectChanged));

        private static void OnSelectedIACObjectChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            VBAutoCompleteBox me = d as VBAutoCompleteBox;
            if (e.NewValue == null)
            {
                me.OnSelectedItemChanged(null);
                me.Text = "";
            }
               
        }

        public List<VBAutoCompleteBoxItem> VBAutoCompleteBoxItems
        {
            get;
            set;
        }
        ...
        /// <summary>
        /// Represents the property where you enter the name of BSO's method. 
        /// The given method will be inovked when the VBAutoCompleteItem is selected with the Enter/Return key or with mouse click.
        /// XAML Example: OnVBAutoCompleteItemSelected = "!StartBSO"
        /// </summary>
        [Category("VBControl")]
