    ...
    public class VBWindowDialog : VBWindow
    {
        private static List<CustomControlStyleInfo> _styleInfoList = new List<CustomControlStyleInfo> { 
            new CustomControlStyleInfo { wpfTheme = eWpfTheme.Gip, 
                                         ...
                                         styleUri = "/gip.core.layoutengine;Component/Controls/VBDocking/VBWindow/Themes/DialogStyleGip.xaml" },
            new CustomControlStyleInfo { wpfTheme = eWpfTheme.Aero, 
                                         styleName = "DialogStyleAero", 
                                         styleUri = "/gip.core.layoutengine;Component/Controls/VBDocking/VBWindow/Themes/DialogStyleAero.xaml" },
        };
        /// <summary>
