...
namespace gip.core.reporthandler 
{
	internal class ObjectTable<T> : ITable, IEnumerable<ITableRow>, IEnumerable, ICanHandleUsedIdentifiers, ISupplyParentTable
	{
        ...
        public ObjectTable(ObjectDataProvider provider, ISupplyParentTable parentTable, string tableName, string sourcePropertyName, IEnumerable source, IEnumerable parentEnumerable, string navigationId, ACClass acClass)
		{
		...
		public void ApplyFilter(string filter)
		{
			...
			for (int i = 1; i <= array.GetUpperBound(0); i++)
			{
				...
				catch (NullReferenceException e)
				{
                    ...
                    this.Root().Messages.LogException("ObjectTableRow<T>", "ApplyFilter", msg);
