...
namespace Document.Editor
{
    public class DocumentEditor : RichTextBox, INotifyPropertyChanged
    {
        ...
        private gip.core.reporthandlerwpf.Flowdoc.VBReportEditor _ReportEditor;
        ...
        public DocumentEditor()
        {
            ...
            FontFamily = gip.core.reporthandlerwpf.Properties.Settings.Default.Options_DefaultFont;
            FontSize = gip.core.reporthandlerwpf.Properties.Settings.Default.Options_DefaultFontSize;
            AcceptsTab = true;
        ...
        private void DocumentEditor_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                _ReportEditor = gip.core.layoutengine.Helperclasses.VBVisualTreeHelper.FindParentObjectInVisualTree(this, typeof(gip.core.reporthandlerwpf.Flowdoc.VBReportEditor)) as gip.core.reporthandlerwpf.Flowdoc.VBReportEditor;
            }
        }
