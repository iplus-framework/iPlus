...
namespace gip.core.autocomponent
{
        ...
        where T : ACComponent
    {
        ...
        /// </summary>
        /// <param name="atACObject">ACObject which publish events</param>
        /// <param name="eventName">Name of event</param>
        /// <param name="asyncCallbackDelegateName">Event-Handler-CallBack-Delegate of this</param>
        /// <returns></returns>
